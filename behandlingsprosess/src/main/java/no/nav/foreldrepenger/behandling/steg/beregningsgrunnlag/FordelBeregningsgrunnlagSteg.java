...
import no.nav.foreldrepenger.domene.prosess.BeregningsgrunnlagInputProvider;
...
public class FordelBeregningsgrunnlagSteg implements BeregningsgrunnlagSteg {
    ...
    public BehandleStegResultat utførSteg(BehandlingskontrollKontekst kontekst) {
        var beregningsgrunnlagResultat = beregningTjeneste.beregn(kontekst.getBehandlingId(), BehandlingStegType.FORDEL_BEREGNINGSGRUNNLAG);
    ...
    public void vedHoppOverBakover(BehandlingskontrollKontekst kontekst,
        ...
        beregningTjeneste.rydd(kontekst, BehandlingStegType.FORDEL_BEREGNINGSGRUNNLAG, tilSteg);
    }
