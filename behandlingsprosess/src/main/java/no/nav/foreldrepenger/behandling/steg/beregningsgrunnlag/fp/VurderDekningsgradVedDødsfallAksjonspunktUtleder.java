...
public class VurderDekningsgradVedDødsfallAksjonspunktUtleder {
    ...
    public static List<AksjonspunktResultat> utled(List<AksjonspunktResultat> apResultat, int dekningsgradFraFagsakRelasjon, List<UidentifisertBarn> barnList) {
    ...
    private static boolean utledAksjonspunktVedDødfødselOgDekningsgradUlik100(int dekningsgradFraFagsakRelasjon, List<UidentifisertBarn> registerBarn) {
