...
import no.nav.foreldrepenger.behandlingslager.geografisk.Postnummer;
...
public class PostnummerSynkroniseringTjeneste {
    ...
    private PostnummerKodeverkRepository poststedKodeverkRepository;
    ...
    @Inject
    PostnummerSynkroniseringTjeneste(PostnummerKodeverkRepository poststedKodeverkRepository,
