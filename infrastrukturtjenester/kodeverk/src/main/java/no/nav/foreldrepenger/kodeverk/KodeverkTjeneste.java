...
public class KodeverkTjeneste {
    ...
    private static void oversettFraKodeverkListe(FinnKodeverkListeResponse response, List<KodeverkInfo> resultat) {
     ...
     *
     * NB: Sorterer liste i reverse order for at LandkoderISO2 skal komme foran
     * Landkoder.
     */
    private static Optional<String> getKodeverkFraUri(String uri, List<EnkeltKodeverk> brukerKodeverk) {
    ...
    private static KodeverkKode oversettFraKode(Kode kode, String kodeverkNavn, String kodeverkSpråk) {
        Optional<Tuple<LocalDate, LocalDate>> gyldighetsperiode = finnGyldighetsperiode(kode.getGyldighetsperiode());
        Optional<String> term = finnTerm(kode.getTerm(), kodeverkSpråk);
        return new KodeverkKode.Builder()
     ...
     * bokmål).
     */
    private static Optional<String> finnTerm(List<Term> termList, String kodeverkSpråk) {
