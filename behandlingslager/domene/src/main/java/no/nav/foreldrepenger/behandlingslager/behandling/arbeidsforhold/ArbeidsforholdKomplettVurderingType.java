...
public enum ArbeidsforholdKomplettVurderingType implements Kodeverdi, DatabaseKode {
    ...
    MELDING_TIL_ARBEIDSGIVER("MELDING_TIL_ARBEIDSGIVER_NAV_NO", "Ny melding sendes til arbeidsgiver med beskjed om å sende inntektsmelding på Min side - arbeidsgiver og Altinn innboks"),
