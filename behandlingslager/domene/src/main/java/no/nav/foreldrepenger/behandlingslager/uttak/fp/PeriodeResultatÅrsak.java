...
public enum PeriodeResultatÅrsak implements Kodeverdi {
    ...
    ANNEN_FORELDER_UTTAK_EØS
        ("4108", "14-10-6", "§14-10 sjette ledd, artikkel 5 i Forordning (EF) 883/2004: Annen part har overlappende uttak i EØS, det er ikke søkt/innvilget samtidig uttak", "{\"fagsakYtelseType\": {\"FP\": {\"lovreferanse\": \"14-10\"}}}",
            of(UTTAK)),
