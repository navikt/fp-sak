...
public class PeriodeUtenOmsorgEntitet extends DokumentasjonPeriodeEntitet<PeriodeUtenOmsorgEntitet> {
    ...
    PeriodeUtenOmsorgEntitet(PeriodeUtenOmsorgEntitet periode) {
        super(periode);
    }
