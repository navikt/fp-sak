...
public enum BehandlingResultatType implements Kodeverdi {
    ...
    KLAGE_TILBAKEKREVING_VEDTAK_STADFESTET("KLAGE_TILBAKEKREVING_VEDTAK_STADFESTET",
        "Tilbakekrevingsvedtak stadfestet"), // Brukes av kun Tilbakekreving eller Tilbakekreving Revurdering
    ...
    private static final Set<BehandlingResultatType> HENLEGGELSESKODER_FOR_SØKNAD = Set.of(HENLAGT_SØKNAD_TRUKKET, HENLAGT_FEILOPPRETTET,
        HENLAGT_BRUKER_DØD, HENLAGT_SØKNAD_MANGLER, MANGLER_BEREGNINGSREGLER);
    private static final Set<BehandlingResultatType> ALLE_HENLEGGELSESKODER = Set.of(HENLAGT_SØKNAD_TRUKKET, HENLAGT_FEILOPPRETTET,
        HENLAGT_BRUKER_DØD, HENLAGT_KLAGE_TRUKKET, HENLAGT_ANKE_TRUKKET, MERGET_OG_HENLAGT, HENLAGT_SØKNAD_MANGLER, HENLAGT_INNSYN_TRUKKET,
        MANGLER_BEREGNINGSREGLER);
    private static final Set<BehandlingResultatType> ALLE_INNVILGET_KODER = Set.of(INNVILGET, FORELDREPENGER_ENDRET, FORELDREPENGER_SENERE,
        INGEN_ENDRING);
