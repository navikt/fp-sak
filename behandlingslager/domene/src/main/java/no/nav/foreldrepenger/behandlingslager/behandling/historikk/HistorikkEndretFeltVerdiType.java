...
public enum HistorikkEndretFeltVerdiType implements Kodeverdi {
    ...
    FASTSETT_RESULTAT_PERIODEN_INNLEGGELSEN_DOKUMENTERT_IKKE("FASTSETT_RESULTAT_PERIODEN_INNLEGGELSEN_DOKUMENTERT_IKKE",
        "Innleggelsen er ikke dokumentert"),
    FASTSETT_RESULTAT_PERIODEN_HV_DOKUMENTERT_IKKE("FASTSETT_RESULTAT_PERIODEN_HV_DOKUMENTERT_IKKE",
        "Øvelse eller tjeneste i heimevernet er ikke dokumentert"),
    FASTSETT_RESULTAT_PERIODEN_NAV_TILTAK_DOKUMENTERT_IKKE("FASTSETT_RESULTAT_PERIODEN_NAV_TILTAK_DOKUMENTERT_IKKE",
        "Tiltak i regi av NAV er ikke dokumentert"),
    ...
    GRADERING_PÅ_ANDEL_UTEN_BG_IKKE_SATT_PÅ_VENT("GRADERING_PÅ_ANDEL_UTEN_BG_IKKE_SATT_PÅ_VENT",
        "Ikke feil i inntektsgrunnlag, fortsett behandlingen"),
