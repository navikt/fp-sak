...
public class PeriodeAleneOmsorgEntitet extends DokumentasjonPeriodeEntitet<PeriodeAleneOmsorgEntitet> {
    ...
    PeriodeAleneOmsorgEntitet(PeriodeAleneOmsorgEntitet periode) {
        super(periode);
    }
