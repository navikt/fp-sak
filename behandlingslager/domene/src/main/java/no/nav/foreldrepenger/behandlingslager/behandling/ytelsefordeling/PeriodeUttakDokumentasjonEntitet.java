...
public class PeriodeUttakDokumentasjonEntitet extends DokumentasjonPeriodeEntitet<PeriodeUttakDokumentasjonEntitet> {
    ...
    PeriodeUttakDokumentasjonEntitet(PeriodeUttakDokumentasjonEntitet periode) {
        super(periode);
    }
