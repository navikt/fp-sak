...
import static no.nav.foreldrepenger.behandlingslager.uttak.fp.PeriodeUtfallÅrsak.LovEndring.FRITT_UTTAK;
import static no.nav.foreldrepenger.behandlingslager.uttak.fp.PeriodeUtfallÅrsak.LovEndring.KREVER_SAMMENHENGENDE_UTTAK;
...
public enum PeriodeUtfallÅrsak implements Kodeverdi, ÅrsakskodeMedLovreferanse {
    ...
    private static final Map<String, PeriodeUtfallÅrsak> KODER = new LinkedHashMap<>();
    ...
    PeriodeUtfallÅrsak(String kode,
                       String navn,
                       String lovHjemmel,
    ...
    public static Map<String, PeriodeUtfallÅrsak> kodeMap() {
    ...
    public static class KodeverdiConverter implements AttributeConverter<PeriodeUtfallÅrsak, String> {
        @Override
        public String convertToDatabaseColumn(PeriodeUtfallÅrsak attribute) {
