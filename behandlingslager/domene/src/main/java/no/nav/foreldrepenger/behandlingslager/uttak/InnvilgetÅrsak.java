...
public enum InnvilgetÅrsak implements PeriodeResultatÅrsak {
    ...
    FORELDREPENGER_REDUSERT_GRAD_PGA_ANNEN_FORELDERS_UTTAK("2038", "§ 14-10 sjette ledd: Redusert uttaksgrad pga. den andre forelderens uttak", "{\"fagsakYtelseType\": {\"FP\": {\"lovreferanse\": \"14-10\"}}}", Set.of(UTTAK)),
    ;
