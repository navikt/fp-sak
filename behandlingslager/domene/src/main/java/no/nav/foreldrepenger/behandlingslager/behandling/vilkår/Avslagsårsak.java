...
public enum Avslagsårsak implements Kodeverdi, ÅrsakskodeMedLovreferanse {
    ...
    BARN_IKKE_UNDER_15_ÅR("1013", "Barn ikke under 15 år",
    ...
    MANGLENDE_DOKUMENTASJON("1019", "Manglende dokumentasjon",
        "{\"fagsakYtelseType\": [{\"FP\": [{\"kategori\": \"FP_VK_34\", \"lovreferanse\": \"21-3\"}]}]}"),
    ...
    SN_FL_HAR_MULIGHET_TIL_Å_TILRETTELEGGE_SITT_VIRKE("1066",
        "§14-4 andre ledd: Næringsdrivende/frilanser har mulighet til å tilrettelegge sitt virke",
        "{\"fagsakYtelseType\": [{\"SVP\": [{\"kategori\": \"SVP_VK_1\", \"lovreferanse\": \"14-4 2. ledd\"}]}]}"),
