...
public enum Venteårsak implements Kodeverdi {
    ...
    VENT_PÅ_SISTE_AAP_ELLER_DP_MELDEKORT("VENT_PÅ_SISTE_AAP_MELDEKORT",
        "Venter på siste meldekort for AAP eller dagpenger før første uttaksdag."), // Kalkulus
    ...
    VENT_LOVENDRING_8_41("VENT_LOVENDRING_8_41",
        "Venter på vedtak om lovendring vedrørende beregning av næring i kombinasjon med arbeid eller frilans"),
