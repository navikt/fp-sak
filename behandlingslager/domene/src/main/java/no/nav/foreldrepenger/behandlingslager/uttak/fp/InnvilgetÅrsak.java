...
public enum InnvilgetÅrsak implements PeriodeResultatÅrsak {
    ...
    UTSETTELSE_GYLDIG_BFR_AKT_KRAV_OPPFYLT("2028", "§14-14, jf. 14-13: Bare far rett, aktivitetskravet oppfylt", "{\"fagsakYtelseType\": {\"FP\": {\"lovreferanse\": \"14-14,14-13\"}}}", of(UTSETTELSE), of(FORELDREPENGER), null, null, of(FRITT_UTTAK)),
