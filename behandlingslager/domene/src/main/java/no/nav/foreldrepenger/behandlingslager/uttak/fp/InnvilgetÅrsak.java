...
public enum InnvilgetÅrsak implements PeriodeResultatÅrsak {
    ...
    UTTAK_OPPFYLT("2001", "§14-6: Uttak er oppfylt", "{\"fagsakYtelseType\": {\"FP\": {\"lovreferanse\": \"14-6\"}}}", Set.of(UTTAK), null, null, LocalDate.of(2001, 1, 1), null),
    ...
    UTSETTELSE_GYLDIG_PGA_FERIE("2010", "§14-11 første ledd bokstav a: Gyldig utsettelse pga. ferie", "{\"fagsakYtelseType\": {\"FP\": {\"lovreferanse\": \"14-11\"}}}", Set.of(UTSETTELSE), null, null, null, Set.of(LovEndring.KREVER_SAMMENHENGENDE_UTTAK)),
    UTSETTELSE_GYLDIG_PGA_100_PROSENT_ARBEID("2011", "§14-11 første ledd bokstav b: Gyldig utsettelse pga. 100% arbeid", "{\"fagsakYtelseType\": {\"FP\": {\"lovreferanse\": \"14-11\"}}}", Set.of(UTSETTELSE), null, null, null, Set.of(LovEndring.KREVER_SAMMENHENGENDE_UTTAK)),
    UTSETTELSE_GYLDIG_PGA_INNLEGGELSE("2012", "§14-11 første ledd bokstav c: Gyldig utsettelse pga. innleggelse", "{\"fagsakYtelseType\": {\"FP\": {\"lovreferanse\": \"14-11\"}}}", Set.of(UTSETTELSE), null, null, null, Set.of(LovEndring.KREVER_SAMMENHENGENDE_UTTAK)),
    UTSETTELSE_GYLDIG_PGA_BARN_INNLAGT("2013", "§14-11 første ledd bokstav d: Gyldig utsettelse pga. barn innlagt", "{\"fagsakYtelseType\": {\"FP\": {\"lovreferanse\": \"14-11\"}}}", Set.of(UTSETTELSE), null, null, null, Set.of(LovEndring.KREVER_SAMMENHENGENDE_UTTAK)),
    UTSETTELSE_GYLDIG_PGA_SYKDOM("2014", "§14-11 første ledd bokstav c: Gyldig utsettelse pga. sykdom", "{\"fagsakYtelseType\": {\"FP\": {\"lovreferanse\": \"14-11\"}}}", Set.of(UTSETTELSE), null, null, null, Set.of(LovEndring.KREVER_SAMMENHENGENDE_UTTAK)),
    ...
    InnvilgetÅrsak(String kode, String navn, String lovHjemmel, Set<UttakType> uttakTyper) {
        this(kode, navn, lovHjemmel, uttakTyper, Set.of());
    }
