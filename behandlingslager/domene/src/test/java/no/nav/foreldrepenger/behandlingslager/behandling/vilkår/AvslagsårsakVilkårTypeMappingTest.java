...
class AvslagsårsakVilkårTypeMappingTest {
    ...
    void skal_hente_alle_avslagsårsaker_gruppert_på_vilkårstype() {
        ...
        assertThat(map.get(VilkårType.FORELDREANSVARSVILKÅRET_4_LEDD)).containsOnly(Avslagsårsak.SØKER_ER_IKKE_BARNETS_FAR_F,
            Avslagsårsak.OMSORGSOVERTAKELSE_ETTER_56_UKER, Avslagsårsak.IKKE_FORELDREANSVAR_ALENE_ETTER_BARNELOVA,
