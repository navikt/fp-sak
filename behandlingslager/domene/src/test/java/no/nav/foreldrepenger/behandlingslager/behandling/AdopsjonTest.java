...
class AdopsjonTest {
    ...
    void skal_merge_fra_gammel_til_ny_adopsjon() {
        ...
        var hendelseAggregat = byggAggregat(now);
        var søknadVersjon = hendelseAggregat.getGjeldendeVersjon();
    ...
    void skal_merge_fra_gammel_til_ny_adopsjon_med_oppdaterte_verdier() {
        ...
        var oppdatere = FamilieHendelseGrunnlagBuilder.oppdatere(Optional.of(hendelseAggregat));
        var oppdatertHendelse = FamilieHendelseBuilder.oppdatere(Optional.of(hendelseAggregat.getSøknadVersjon()), HendelseVersjonType.SØKNAD);
        ...
        var oppdatertHendelseAggregat = oppdatere.medBekreftetVersjon(oppdatertHendelse).build();
        var gjellendeVersjon = oppdatertHendelseAggregat.getGjeldendeVersjon();
    ...
    private FamilieHendelseGrunnlagEntitet byggAggregat(LocalDate now) {
        ...
        var oppdatere = FamilieHendelseGrunnlagBuilder.oppdatere(Optional.empty());
        var builder = FamilieHendelseBuilder.oppdatere(Optional.empty(), HendelseVersjonType.SØKNAD);
        var adopsjonBuilder = builder.getAdopsjonBuilder();
