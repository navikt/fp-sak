...
public class AdopsjonTest {
    ...
    public void skal_merge_fra_gammel_til_ny_adopsjon() {
        ...
        final FamilieHendelseGrunnlagEntitet hendelseAggregat = byggAggregat(now);
        final FamilieHendelseEntitet søknadVersjon = hendelseAggregat.getGjeldendeVersjon();
    ...
    public void skal_merge_fra_gammel_til_ny_adopsjon_med_oppdaterte_verdier() {
        ...
        final FamilieHendelseGrunnlagEntitet oppdatertHendelseAggregat = oppdatere.medBekreftetVersjon(oppdatertHendelse).build();
        final FamilieHendelseEntitet gjellendeVersjon = oppdatertHendelseAggregat.getGjeldendeVersjon();
