...
public class BehandlingsgrunnlagKodeverkRepositoryImplTest {
    ...
    private BehandlingsgrunnlagKodeverkRepository repo = new BehandlingsgrunnlagKodeverkRepository(repoRule.getEntityManager());

    @Test
    public void skal_verifisere_kodeverk_som_mottas_fra_regelmotor() {
        assertThat(FarSøkerType.fraKode("ADOPTERER_ALENE")).isEqualTo(FarSøkerType.ADOPTERER_ALENE);
