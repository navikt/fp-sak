...
== Hensikt
Joark er NAVs journalarkiv.  Vedtaksløsningen benytter Joark tjenestene Journal_V3, BehandleinngaaendeJournal_V1 og InngaaendeJournal_V1 til å hente metadata om innkommende søknadsdokumenter og vedlegg, og til å journalføre dokumenter når de behandles i VL.

== Hvordan
Input og outputverdier for tjenestene er beskrevet i tjenestekatalogen.

Journal_V3: https://confluence.adeo.no/display/SDFS/tjeneste_v3%3Avirksomhet%3AJournal_v3[tjeneste_v3:virksomhet:Journal_v3]
...
|Journal_V3|hentDokument|Henter opp xml av hovedokumentet og sender det videre til klargjøringVL. Xml-dokumentet. KlargjøringVL Dokumentet lagres i saksopplysning_dokument-tabellen og sendes videre til HåndterMottattDokumentTask. Dette skjer synkront
|===
...
|Journal_V3| hentDokument| Henter opp xml av hovedokumentet og sender det videre til klargjøringVL. Xml-dokumentet. Dokumentet lagres i saksopplysning_dokument-tabellen og sendes videre til HåndterMottattDokumentTask
|===
...
|journal_v3| hentJournalpostListe| Vi spør Joark om dokumentliste og sjekker det som finnes i vedleggslisten på søknaden mot det som ligger i Joark. Vedleggslisten på søknaden regnes altså i denne omgang som fasit på hva som er påkrevd.
|===
...
|Journal_V3| hentDokument| rest-kall /hent-dokument henter dokumentet. Brukes fra frontend til se dokumenter lagret på fpsak.
|Journal_V3| hentJournalpostListe| rest-kall /hent-dokumentliste for å hente en liste med alle dokumenter til en sak.
|===
