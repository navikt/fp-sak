...
public class Sysdoclet implements jdk.javadoc.doclet.Doclet {
    ...
    static {
        ...
        System.setProperty("doc.plugin.jdbc.db.migration.dvhDS", "filesystem:../migreringer/src/main/resources/db/migration/dvhDS");
