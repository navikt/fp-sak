...
grant SELECT on AKSJONSPUNKT_DEF to FPSAK_HIST WITH GRANT OPTION;
grant SELECT on KODELISTE to FPSAK_HIST WITH GRANT OPTION;
grant SELECT on BEHANDLING_STEG_TYPE to FPSAK_HIST WITH GRANT OPTION;
grant SELECT on VURDERINGSPUNKT_DEF to FPSAK_HIST WITH GRANT OPTION;
grant SELECT on KODELISTE_NAVN_I18N to FPSAK_HIST WITH GRANT OPTION;
grant SELECT on BEHANDLING_TYPE_STEG_SEKV to FPSAK_HIST WITH GRANT OPTION;
...
--------------------------------------------------------
--  DDL for View BEHANDLING_TYPE_STEG_SEKV_VIEW
--------------------------------------------------------
CREATE OR REPLACE VIEW FPSAK_HIST.BEHANDLING_TYPE_STEG_SEKV_VIEW AS
SELECT
  BEHANDLING_TYPE,
  ...
  ENDRET_AV,
  ENDRET_TID
FROM FPSAK.BEHANDLING_TYPE_STEG_SEKV;