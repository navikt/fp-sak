...
-- TABLE
  ...
  CREATE TABLE "ABAKUS_FPSAK"
   (	"FAGSAK_ID" NUMBER(19,0) NOT NULL ENABLE,
	"SIST_MIGRERT_TS" TIMESTAMP (6),
	"SIST_MIGRERT_BEHANDLINGER" NUMBER(5,0),
	"SIST_MIGRERT_GRUNNLAG" NUMBER(5,0),
	"SIST_MIGRERT_GRUNNLAG_FEIL" NUMBER(5,0),
	"TRENGER_NY_MIGRERING" CHAR(1) DEFAULT 'J' NOT NULL ENABLE,
	...
	"FAGSAK_VERSJON" NUMBER(19,0),
	"FAGSAK_TIDSPUNKT" TIMESTAMP (3),
	"FEIL" CLOB,
	"SENDT_ABAKUS" CHAR(1) DEFAULT 'N' NOT NULL ENABLE,
	"ABAKUS_FEIL_RESPONS" CLOB,
	"ABAKUS_FEIL_SAMMENLIGNING" CLOB
   ) ;
  ALTER TABLE "ABAKUS_FPSAK" ADD CHECK (trenger_ny_migrering IN ('J', 'N')) ENABLE;
  ALTER TABLE "ABAKUS_FPSAK" ADD CONSTRAINT "PK_ABAKUS_FPSAK" PRIMARY KEY ("FAGSAK_ID")
  USING INDEX  ENABLE;
  ALTER TABLE "ABAKUS_FPSAK" ADD CHECK (sendt_abakus IN ('J', 'N')) ENABLE;

  CREATE TABLE "ABAKUS_IAY_GRUNNLAG"
   (	"IAY_UUID" RAW(16) NOT NULL ENABLE,
	"SAKSNUMMER" VARCHAR2(19 CHAR) NOT NULL ENABLE,
	"BEHANDLING_UUID" RAW(16) NOT NULL ENABLE,
	"AKTOER_ID" VARCHAR2(50 CHAR) NOT NULL ENABLE,
	"OPPRETTET_TID_ORIGINAL" TIMESTAMP (6) NOT NULL ENABLE,
	"AKTIV_ORIGINAL" CHAR(1) DEFAULT 'N' NOT NULL ENABLE,
	"ARBEIDSFORHOLD_INFO_REFERANSER" NUMBER(5,0),
	"ARBEIDSFORHOLD_OVERSTYRINGER" NUMBER(5,0),
	"AKTOER_ARBEID_OVERSTYRT" NUMBER(5,0),
	"OPPGITT_OPPTJ_ARBEID" NUMBER(5,0),
	"OPPGITT_OPPTJ_EGEN_NAERING" NUMBER(5,0),
	"OPPGITT_OPPTJ_ANNEN" NUMBER(5,0),
	"OPPGITT_OPPTJ_FRILANS" NUMBER(5,0),
	"IAY_JSON" CLOB,
	"TIL_DTO_FEIL" CLOB,
	"FRA_DTO_FEIL" CLOB,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	...
	"ENDRET_AV" VARCHAR2(20 CHAR),
	"ENDRET_TID" TIMESTAMP (3),
	"ABAKUS_SAMMENLIGNING" CLOB,
	"ABAKUS_JSON" CLOB
   ) ;
  ALTER TABLE "ABAKUS_IAY_GRUNNLAG" ADD CHECK (aktiv_original IN ('J', 'N')) ENABLE;
  ALTER TABLE "ABAKUS_IAY_GRUNNLAG" ADD CONSTRAINT "PK_ABAKUS_IAY_GRUNNLAG" PRIMARY KEY ("IAY_UUID")
  USING INDEX  ENABLE;
  ...
  CREATE TABLE "IAY_AKTIVITETS_AVTALE"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"YRKESAKTIVITET_ID" NUMBER(19,0) NOT NULL ENABLE,
	...
	"ANTALL_TIMER" NUMBER(6,2),
	"ANTALL_TIMER_FULLTID" NUMBER(6,2)
   ) ;
  ...
  CREATE TABLE "IAY_AKTOER_ARBEID"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"INNTEKT_ARBEID_YTELSER_ID" NUMBER(19,0) NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	"OPPRETTET_TID" TIMESTAMP (3) DEFAULT systimestamp NOT NULL ENABLE,
	"ENDRET_AV" VARCHAR2(20 CHAR),
  ...
  CREATE TABLE "IAY_ANNEN_AKTIVITET"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"OPPGITT_OPPTJENING_ID" NUMBER(19,0) NOT NULL ENABLE,
	"FOM" DATE NOT NULL ENABLE,
	"TOM" DATE NOT NULL ENABLE,
	"ARBEID_TYPE" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	"OPPRETTET_TID" TIMESTAMP (3) DEFAULT systimestamp NOT NULL ENABLE,
	"ENDRET_AV" VARCHAR2(20 CHAR),
	"ENDRET_TID" TIMESTAMP (3)
  ...
  CREATE TABLE "IAY_ARBEIDSFORHOLD"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"INFORMASJON_ID" NUMBER(19,0) NOT NULL ENABLE,
	"ARBEIDSGIVER_AKTOR_ID" VARCHAR2(100 CHAR),
	"BEGRUNNELSE" VARCHAR2(2000 CHAR),
	"HANDLING_TYPE" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	...
	"ARBEIDSGIVER_ORGNR" VARCHAR2(100 CHAR),
	"ARBEIDSFORHOLD_INTERN_ID" RAW(16),
	"BEKREFTET_PERMISJON_STATUS" VARCHAR2(100 CHAR) DEFAULT '-' NOT NULL ENABLE,
	"BEKREFTET_PERMISJON_FOM" DATE,
	"BEKREFTET_PERMISJON_TOM" DATE,
	"NY_ARBEIDSFORHOLD_INTERN_ID" RAW(16)
   ) ;
  ...
  CREATE TABLE "IAY_ARBEIDSFORHOLD_REFER"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"INFORMASJON_ID" NUMBER(19,0) NOT NULL ENABLE,
	"EKSTERN_REFERANSE" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"ARBEIDSGIVER_AKTOR_ID" VARCHAR2(100 CHAR),
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	"OPPRETTET_TID" TIMESTAMP (3) DEFAULT systimestamp NOT NULL ENABLE,
  ...
  CREATE TABLE "IAY_EGEN_NAERING"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	...
	"REGNSKAPSFOERER_NAVN" VARCHAR2(400 CHAR),
	"REGNSKAPSFOERER_TLF" VARCHAR2(100 CHAR),
	"ENDRING_DATO" DATE,
	"BEGRUNNELSE" VARCHAR2(1000 CHAR),
	"BRUTTO_INNTEKT" NUMBER(11,2),
	...
	"ENDRET_AV" VARCHAR2(20 CHAR),
	"ENDRET_TID" TIMESTAMP (3),
	"NYOPPSTARTET" VARCHAR2(1 CHAR) DEFAULT 'N' NOT NULL ENABLE,
	"VARIG_ENDRING" VARCHAR2(1 CHAR) DEFAULT 'N' NOT NULL ENABLE,
	"NY_I_ARBEIDSLIVET" VARCHAR2(1 CHAR) DEFAULT 'N' NOT NULL ENABLE,
	"NAER_RELASJON" VARCHAR2(1 CHAR) NOT NULL ENABLE,
	"VIRKSOMHET_ORGNR" VARCHAR2(100 CHAR)
   ) ;
  ...
  CREATE TABLE "IAY_GRADERING"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"INNTEKTSMELDING_ID" NUMBER(19,0) NOT NULL ENABLE,
	"ARBEIDSTID_PROSENT" NUMBER(5,2) NOT NULL ENABLE,
	"FOM" DATE NOT NULL ENABLE,
	"TOM" DATE NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
  ...
  CREATE TABLE "IAY_INNTEKT"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"AKTOER_INNTEKT_ID" NUMBER(19,0) NOT NULL ENABLE,
  ...
  CREATE TABLE "IAY_INNTEKTSMELDING"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"INNTEKTSMELDINGER_ID" NUMBER(19,0) NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"INNTEKT_BELOEP" NUMBER(10,2) NOT NULL ENABLE,
	...
	"ENDRET_AV" VARCHAR2(20 CHAR),
	"ENDRET_TID" TIMESTAMP (3),
	"INNSENDINGSAARSAK" VARCHAR2(100 CHAR) DEFAULT '-' NOT NULL ENABLE,
	"INNSENDINGSTIDSPUNKT" TIMESTAMP (6) NOT NULL ENABLE,
	"ARBEIDSGIVER_AKTOR_ID" VARCHAR2(100 CHAR),
	"KANALREFERANSE" VARCHAR2(100 CHAR),
	"KILDESYSTEM" VARCHAR2(200 CHAR),
	"ARBEIDSGIVER_ORGNR" VARCHAR2(100 CHAR),
	"JOURNALPOST_ID" VARCHAR2(100 CHAR),
	"YTELSE_TYPE" VARCHAR2(100 CHAR),
	"ARBEIDSFORHOLD_INTERN_ID" RAW(16),
  ...
  CREATE TABLE "IAY_INNTEKTSPOST"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"INNTEKT_ID" NUMBER(19,0) NOT NULL ENABLE,
	"INNTEKTSPOST_TYPE" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"FOM" DATE NOT NULL ENABLE,
	"TOM" DATE NOT NULL ENABLE,
	"BELOEP" NUMBER(19,2) NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	"OPPRETTET_TID" TIMESTAMP (3) DEFAULT systimestamp NOT NULL ENABLE,
	"ENDRET_AV" VARCHAR2(20 CHAR),
	...
	"SKATTE_OG_AVGIFTSREGEL_TYPE" VARCHAR2(100 CHAR) DEFAULT '-' NOT NULL ENABLE
   ) ;
  ...
  CREATE TABLE "IAY_NATURAL_YTELSE"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"INNTEKTSMELDING_ID" NUMBER(19,0) NOT NULL ENABLE,
	"NATURAL_YTELSE_TYPE" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"BELOEP_MND" NUMBER(10,2) NOT NULL ENABLE,
	"FOM" DATE NOT NULL ENABLE,
	"TOM" DATE NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
  ...
  CREATE TABLE "IAY_OPPGITT_ARBEIDSFORHOLD"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	...
	"FOM" DATE NOT NULL ENABLE,
	"TOM" DATE NOT NULL ENABLE,
	"UTENLANDSK_INNTEKT" VARCHAR2(1) NOT NULL ENABLE,
	"ARBEID_TYPE" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"UTENLANDSK_VIRKSOMHET_NAVN" VARCHAR2(100 CHAR),
	"LAND" VARCHAR2(100 CHAR),
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
  ...
  CREATE TABLE "IAY_OVERSTYRTE_PERIODER"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"FOM" DATE NOT NULL ENABLE,
	"TOM" DATE NOT NULL ENABLE,
	"ARBEIDSFORHOLD_ID" NUMBER(19,0) NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	"OPPRETTET_TID" TIMESTAMP (3) DEFAULT systimestamp NOT NULL ENABLE,
	"ENDRET_AV" VARCHAR2(20 CHAR),
  ...
  ALTER TABLE "IAY_OVERSTYRTE_PERIODER" ADD CONSTRAINT "PK_IAY_OVERSTYRTE_PERIODER" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;

  CREATE TABLE "IAY_PERMISJON"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"YRKESAKTIVITET_ID" NUMBER(19,0) NOT NULL ENABLE,
	"BESKRIVELSE_TYPE" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"FOM" DATE NOT NULL ENABLE,
	"TOM" DATE NOT NULL ENABLE,
	"PROSENTSATS" NUMBER(5,2) NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	"OPPRETTET_TID" TIMESTAMP (3) DEFAULT systimestamp NOT NULL ENABLE,
	"ENDRET_AV" VARCHAR2(20 CHAR),
  ...
  CREATE TABLE "IAY_REFUSJON"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"INNTEKTSMELDING_ID" NUMBER(19,0) NOT NULL ENABLE,
	"REFUSJONSBELOEP_MND" NUMBER(10,2) NOT NULL ENABLE,
	"FOM" DATE NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	"OPPRETTET_TID" TIMESTAMP (3) DEFAULT systimestamp NOT NULL ENABLE,
  ...
  CREATE TABLE "IAY_RELATERT_YTELSE"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"AKTOER_YTELSE_ID" NUMBER(19,0) NOT NULL ENABLE,
	"YTELSE_TYPE" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"FOM" DATE NOT NULL ENABLE,
	"TOM" DATE NOT NULL ENABLE,
	"STATUS" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"KILDE" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	"OPPRETTET_TID" TIMESTAMP (3) DEFAULT systimestamp NOT NULL ENABLE,
	"ENDRET_AV" VARCHAR2(20 CHAR),
  ...
  CREATE TABLE "IAY_UTSETTELSE_PERIODE"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"INNTEKTSMELDING_ID" NUMBER(19,0) NOT NULL ENABLE,
	"UTSETTELSE_AARSAK_TYPE" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"FOM" DATE NOT NULL ENABLE,
	"TOM" DATE NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
  ...
  CREATE TABLE "IAY_YRKESAKTIVITET"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"AKTOER_ARBEID_ID" NUMBER(19,0) NOT NULL ENABLE,
	"ARBEIDSGIVER_AKTOR_ID" VARCHAR2(100 CHAR),
	"ARBEID_TYPE" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
  ...
  CREATE TABLE "IAY_YTELSE_ANVIST"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"YTELSE_ID" NUMBER(19,0) NOT NULL ENABLE,
	"BELOEP" NUMBER(19,2),
	"FOM" DATE NOT NULL ENABLE,
	"TOM" DATE NOT NULL ENABLE,
  ...
  CREATE TABLE "IAY_YTELSE_GRUNNLAG"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	...
	"ENDRET_AV" VARCHAR2(20 CHAR),
	"ENDRET_TID" TIMESTAMP (3),
	"ARBEIDSKATEGORI" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"DAGSATS" NUMBER(19,2)
   ) ;
  ...
  CREATE TABLE "IAY_YTELSE_STOERRELSE"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"YTELSE_GRUNNLAG_ID" NUMBER(19,0) NOT NULL ENABLE,
	"BELOEP" NUMBER(19,2) NOT NULL ENABLE,
	"HYPPIGHET" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	"OPPRETTET_TID" TIMESTAMP (3) DEFAULT systimestamp NOT NULL ENABLE,
	"ENDRET_AV" VARCHAR2(20 CHAR),
  ...
  CREATE TABLE "SO_OPPGITT_FRILANS"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"OPPGITT_OPPTJENING_ID" NUMBER(19,0) NOT NULL ENABLE,
	"INNTEKT_FRA_FOSTERHJEM" VARCHAR2(1) NOT NULL ENABLE,
	"NYOPPSTARTET" VARCHAR2(1) NOT NULL ENABLE,
	"NAER_RELASJON" VARCHAR2(1) NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	"OPPRETTET_TID" TIMESTAMP (3) DEFAULT systimestamp NOT NULL ENABLE,
	"ENDRET_AV" VARCHAR2(20 CHAR),
  ...
  CREATE TABLE "SO_OPPGITT_FRILANSOPPDRAG"
   (	"ID" NUMBER(19,0) NOT NULL ENABLE,
	"FRILANS_ID" NUMBER(19,0) NOT NULL ENABLE,
	"FOM" DATE NOT NULL ENABLE,
	"TOM" DATE NOT NULL ENABLE,
	"OPPDRAGSGIVER" VARCHAR2(100 CHAR) NOT NULL ENABLE,
	"VERSJON" NUMBER(19,0) DEFAULT 0 NOT NULL ENABLE,
	"OPPRETTET_AV" VARCHAR2(20 CHAR) DEFAULT 'VL' NOT NULL ENABLE,
	"OPPRETTET_TID" TIMESTAMP (3) DEFAULT systimestamp NOT NULL ENABLE,
	"ENDRET_AV" VARCHAR2(20 CHAR),
...
-- SEQUENCE
   ...
   CREATE SEQUENCE  "SEQ_AKTIVITETER_MOCK"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_AKTIVITETS_AVTALE"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_AKTOER_ARBEID"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_AKTOER_INNTEKT"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_AKTOER_YTELSE"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_ANNEN_AKTIVITET"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_BARN"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_BEHANDLING_REL_YTELSER"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_BEHANDLING_STEG_TYPE_SEKV"  MINVALUE 1005000 INCREMENT BY 50 START WITH 1005000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_BEHANDLING_TYPE_STEG_SEKV"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1010600 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_BEKREFTET_BARN"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_BEKREFTET_FORELDRE"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_BEREGNING"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_DOKUMENT_ADRESSE"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_DOKUMENT_DATA"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_DOKUMENT_FELLES"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_DOKUMENT_MOTTAKER"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_DOKUMENT_TYPE_DATA"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_EGEN_NAERING"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_FAMILIERELASJON"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_FAMILIE_HENDELSE"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_FOEDSEL"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_GRADERING"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_IAY_ARBEIDSFORHOLD"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_IAY_ARBEIDSFORHOLD_REFER"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_IAY_BEKREFTET_PERMISJON"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_IAY_INFORMASJON"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_IAY_OVERSTYRTE_PERIODER"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_INNTEKT"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_INNTEKTSGRUNNLAG_MOCK"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_INNTEKTSMELDING"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_INNTEKTSMELDINGER"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_INNTEKTSMELDING_MANGLENDE"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_INNTEKTSPOST"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_INNTEKT_ARBEID_YTELSER"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_KONFIG_VERDI"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1003350 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_NATURAL_YTELSE"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_OMSORGSOVERTAKELSE"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_OPPGITT_ARBEIDSFORHOLD"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_OPPLYSNING_ADRESSE"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_OPPTJENING_MOCK"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_ORG_MANUELL_BEHANDLING"  MINVALUE 1 INCREMENT BY 50 START WITH 651 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_PERIODER_ALENEOMSORG"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_PERIODER_UTEN_OMSORG"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_PERIODE_ALENEOMSORG"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_PERIODE_UTEN_OMSORG"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_PERMISJON"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_PERSONOPPLYSNING"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_REFUSJON"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_REGEL_MERKNAD"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_RELATERTE_YTELSER"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_RISIKOKLASSIFISERING"  MINVALUE 10000 INCREMENT BY 50 START WITH 10000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_SAKSOPPLYSNING"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_SAKSOPPLYSNING_DOKUMENT"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_SAKSOPPLYSNING_METADATA"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 CACHE 20 NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_SOEKNAD_ADOPSJON_BARN"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_SO_OPPGITT_FRILANS"  MINVALUE 1 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_SO_OPPGITT_FRILANSOPPDRAG"  MINVALUE 1 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_SO_OPPGITT_OPPTJENING"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_SO_RETTIGHET"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_STATSBORGERSKAP"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_SVP_ARBEIDSFORHOLD"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_TASK_LOG"  MINVALUE 1 INCREMENT BY 1 START WITH 21 CACHE 20 NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_TMP_INNTEKT"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_UTSETTELSE_PERIODE"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_UTTAK_RESULTAT_PLAN"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_UTTAK_RES_PER_SOKNAD"  MINVALUE 1000000 INCREMENT BY 50 START WITH 1000000 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_VALGT_OPPLYSNING"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   ...
   CREATE SEQUENCE  "SEQ_YRKESAKTIVITET"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_YTELSE"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_YTELSE_ANVIST"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_YTELSE_GRUNNLAG"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
   CREATE SEQUENCE  "SEQ_YTELSE_STOERRELSE"  MINVALUE 1 INCREMENT BY 50 START WITH 1 NOCACHE  NOCYCLE ;
-- COMMENT

   COMMENT ON COLUMN "ABAKUS_FPSAK"."FAGSAK_ID" IS 'Fagsak som trenger migrering';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."SIST_MIGRERT_TS" IS 'Fagsak som trenger migrering';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."SIST_MIGRERT_BEHANDLINGER" IS 'Antall behandlinger migrert';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."SIST_MIGRERT_GRUNNLAG" IS 'Antall iay grunnlag migrert';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."SIST_MIGRERT_GRUNNLAG_FEIL" IS 'Antall feil på grunnlag';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."TRENGER_NY_MIGRERING" IS 'Hvorvidt trenger migrering (ny eller utdaterte data)';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."SAKSNUMMER" IS 'Saksnummer til fagsak som migreres';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."FAGSAK_VERSJON" IS 'Versjon på fagsak migrert';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."FAGSAK_TIDSPUNKT" IS 'Tidspunkt fagsak var sist endret (evt. opprettet)';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."FEIL" IS 'Feil ved migrering til abakus for fagsak (feimelding returnert fra abakus)';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."SENDT_ABAKUS" IS 'Hvorvidt vi har sendt grunnlag til abakus';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."ABAKUS_FEIL_RESPONS" IS 'Respons fra abakus (dersom annet enn HTTP 200 OK)';
   COMMENT ON COLUMN "ABAKUS_FPSAK"."ABAKUS_FEIL_SAMMENLIGNING" IS 'Hvorvidt grunnlag hentet fra abakus avviker fra hva fpsak har for samme grunnlagreferanse';
   COMMENT ON TABLE "ABAKUS_FPSAK"  IS 'Tabell for å tracke hva som skal migreres til abakus av fagsaker';

   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."IAY_UUID" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."SAKSNUMMER" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."BEHANDLING_UUID" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."AKTOER_ID" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."OPPRETTET_TID_ORIGINAL" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."AKTIV_ORIGINAL" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."ARBEIDSFORHOLD_INFO_REFERANSER" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."ARBEIDSFORHOLD_OVERSTYRINGER" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."AKTOER_ARBEID_OVERSTYRT" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."OPPGITT_OPPTJ_ARBEID" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."OPPGITT_OPPTJ_EGEN_NAERING" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."OPPGITT_OPPTJ_ANNEN" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."OPPGITT_OPPTJ_FRILANS" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."IAY_JSON" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."TIL_DTO_FEIL" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."FRA_DTO_FEIL" IS 'Sporer migrering til abakus';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."ABAKUS_SAMMENLIGNING" IS 'Resultat av sammenligning av grunnlag hentet fra abakus og i fpsak';
   COMMENT ON COLUMN "ABAKUS_IAY_GRUNNLAG"."ABAKUS_JSON" IS 'JSON struktur hentet fra abakus';
   COMMENT ON TABLE "ABAKUS_IAY_GRUNNLAG"  IS 'Tabell som sporer hvilke grunnlag som er er migerrt og evt. feil under migrering';
   ...
   COMMENT ON COLUMN "IAY_ANNEN_AKTIVITET"."ARBEID_TYPE" IS 'Kode for ArbeidType';
   ...
   COMMENT ON COLUMN "IAY_ARBEIDSFORHOLD"."HANDLING_TYPE" IS 'Kode for ArbeidsforholdHandlingType';
   COMMENT ON COLUMN "IAY_ARBEIDSFORHOLD"."STILLINGSPROSENT" IS 'Stillingsprosent for arbeidsforholdet';
   COMMENT ON COLUMN "IAY_ARBEIDSFORHOLD"."NAVN" IS 'Navn for arbeidsforholdet';
   COMMENT ON COLUMN "IAY_ARBEIDSFORHOLD"."ARBEIDSGIVER_ORGNR" IS 'Organisasjonsnummer for arbeidsgivere som er virksomheter';
   COMMENT ON COLUMN "IAY_ARBEIDSFORHOLD"."ARBEIDSFORHOLD_INTERN_ID" IS 'Globalt unikt arbeidsforhold id generert for arbeidsgiver/arbeidsforhold. I motsetning til arbeidsforhold_ekstern_id som holder arbeidsgivers referanse';
   COMMENT ON COLUMN "IAY_ARBEIDSFORHOLD"."BEKREFTET_PERMISJON_STATUS" IS 'Status for bekreftet permisjon på arbeidsforholdet';
   COMMENT ON COLUMN "IAY_ARBEIDSFORHOLD"."BEKREFTET_PERMISJON_FOM" IS 'Fra og med datoen til bekreftet permisjon';
   COMMENT ON COLUMN "IAY_ARBEIDSFORHOLD"."BEKREFTET_PERMISJON_TOM" IS 'Til og med datoen til bekreftet permisjon';
   COMMENT ON COLUMN "IAY_ARBEIDSFORHOLD"."NY_ARBEIDSFORHOLD_INTERN_ID" IS 'Den nye intern nøkkel som representerer arbeidsforhodl-id fra AA-reg etter merge av nøkler';
   ...
   COMMENT ON COLUMN "IAY_ARBEIDSFORHOLD_REFER"."ARBEIDSGIVER_ORGNR" IS 'Organisasjonsnummer for arbeidsgivere som er virksomheter';
   COMMENT ON COLUMN "IAY_ARBEIDSFORHOLD_REFER"."INTERN_REFERANSE_ID" IS 'Globalt unikt arbeidsforhold id generert for arbeidsgiver/arbeidsforhold. I motsetning til arbeidsforhold_ekstern_id som holder arbeidsgivers referanse';
   ...
   COMMENT ON COLUMN "IAY_EGEN_NAERING"."VIRKSOMHET_TYPE" IS 'Kode for hva slags virksomhet egen næring rapporteres for';
   ...
   COMMENT ON COLUMN "IAY_EGEN_NAERING"."LAND" IS 'Kode for hvilket land (ISO3-letter country code) egen næring rapporteres for';
   ...
   COMMENT ON COLUMN "IAY_EGEN_NAERING"."VIRKSOMHET_ORGNR" IS 'Organisasjonsnummer for virksomhet';
   ...
   COMMENT ON COLUMN "IAY_INNTEKT"."KILDE" IS 'Kode for kilde til inntekt (beregning, opptjening, sammenligningsgrunnlag)';
   ...
   COMMENT ON COLUMN "IAY_INNTEKT"."ARBEIDSGIVER_ORGNR" IS 'Organisasjonsnummer for arbeidsgivere som er virksomheter';
   COMMENT ON TABLE "IAY_INNTEKT"  IS 'Inntekter per virksomhet';

   COMMENT ON COLUMN "IAY_INNTEKT_ARBEID_YTELSER"."ID" IS 'Primærnøkkel';
   COMMENT ON COLUMN "IAY_INNTEKT_ARBEID_YTELSER"."UUID" IS 'Unik UUID for behandling til utvortes bruk. Representerer en immutable og unikt identifiserbar instans av dette aggregatet';
   ...
   COMMENT ON COLUMN "IAY_INNTEKTSMELDING"."INNSENDINGSAARSAK" IS 'Kode for årsak til innsending (Ny eller endringsmelding)';
   ...
   COMMENT ON COLUMN "IAY_INNTEKTSMELDING"."ARBEIDSGIVER_ORGNR" IS 'Organisasjonsnummer for arbeidsgivere som er virksomheter';
   COMMENT ON COLUMN "IAY_INNTEKTSMELDING"."JOURNALPOST_ID" IS 'Journalposten inntektsmeldingen er journalført på';
   COMMENT ON COLUMN "IAY_INNTEKTSMELDING"."YTELSE_TYPE" IS 'Ytelse type';
   COMMENT ON COLUMN "IAY_INNTEKTSMELDING"."ARBEIDSFORHOLD_INTERN_ID" IS 'Globalt unikt arbeidsforhold id generert for arbeidsgiver/arbeidsforhold. I motsetning til arbeidsforhold_ekstern_id som holder arbeidsgivers referanse';
   ...
   COMMENT ON COLUMN "IAY_OPPGITT_ARBEIDSFORHOLD"."LAND" IS 'FK: Kodeliste LANDKODER';
   ...
   COMMENT ON COLUMN "IAY_YRKESAKTIVITET"."ARBEIDSGIVER_ORGNR" IS 'Organisasjonsnummer for arbeidsgivere som er virksomheter';
   COMMENT ON COLUMN "IAY_YRKESAKTIVITET"."ARBEIDSFORHOLD_INTERN_ID" IS 'Globalt unikt arbeidsforhold id generert for arbeidsgiver/arbeidsforhold. I motsetning til arbeidsforhold_ekstern_id som holder arbeidsgivers referanse';
   ...
   COMMENT ON COLUMN "IAY_YTELSE_STOERRELSE"."VIRKSOMHET_ORGNR" IS 'Organisasjonsnummer dersom ytelse er knyttet til en virksomhet';
   ...
   COMMENT ON COLUMN "SO_OPPGITT_OPPTJENING"."UUID" IS 'Unik UUID for behandling til utvortes bruk. Representerer en immutable og unikt identifiserbar instans av disse opplysningene';
