...
(
    ...
    MIGRERT_FRA_ID NUMBER(19)
        constraint FK_HISTORIKKINNSLAG2_03 references FPSAK.HISTORIKKINNSLAG
);
...
(
    ...
    SEKVENS_NR  VARCHAR2(100 char)                     not null,
    OPPRETTET_AV        VARCHAR2(20 char) default 'VL'         not null,
    OPPRETTET_TID       TIMESTAMP(3)      default systimestamp not null,
    ENDRET_AV           VARCHAR2(20 char),
    ENDRET_TID          TIMESTAMP(3)
...
comment on column HISTORIKKINNSLAG2_TEKSTLINJE.SEKVENS_NR is 'Rekkefølge på tekstlinjer innad historikkinnslaget';
