 ...
 * med indekser/PK/FK/constraints.
 *
 * Endrer data typer ihht. til planlagt (J/N kolonner til boolean, number(19,0)
 * til BIGINT etc.
 */
public class EksporterPostgresSqlScript {
    ...
    private static String eksporterTabellStruktur() {
        return "with cols as (\n" +
    ...
    private static String eksporterIndekserOgPrimaryKeys() {
    ...
    private static String eksporterForeignKeyDefinitions() {
        return "-- FOREIGN KEYS\n" +
                "with fks as (\n" +
    ...
    private static String eksporterSequenceDefinitions() {
        return "with seqs as (\n" +
