...
public class PersonRestTjeneste {
    ...
    private static final String MEDLEMSKAP_PART_PATH = "/person/medlemskap";
    public static final String MEDLEMSKAP_PATH = BASE_PATH + MEDLEMSKAP_PART_PATH; //NOSONAR TFP-2234
