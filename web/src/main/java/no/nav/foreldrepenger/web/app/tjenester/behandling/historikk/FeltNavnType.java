...
public enum FeltNavnType {
    ...
    OVERSTYRT_BEREGNING("OVERSTYRT_BEREGNING", "Overstyrt beregning: Beløpet"),
    OVERSTYRT_VURDERING("OVERSTYRT_VURDERING", "Overstyrt vurdering: Utfallet"),
    ...
    ER_ANKE_IKKE_KONKRET("ER_ANKE_IKKE_KONKRET", "Er anken ikke konkret"),
    ...
    DELVIS_REFUSJON_FØR_STARTDATO("DELVIS_REFUSJON_FØR_STARTDATO", "Delvis refusjon før {value}"),
