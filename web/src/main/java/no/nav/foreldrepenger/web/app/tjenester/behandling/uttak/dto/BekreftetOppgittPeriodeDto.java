...
public class BekreftetOppgittPeriodeDto {

    @Valid
    private KontrollerFaktaPeriodeLagreDto bekreftetPeriode;
    ...
    public KontrollerFaktaPeriodeLagreDto getBekreftetPeriode() {
        return bekreftetPeriode;
    }

    public void setBekreftetPeriode(KontrollerFaktaPeriodeLagreDto bekreftetPeriode) {
        this.bekreftetPeriode = bekreftetPeriode;
    }

    public UttakPeriodeVurderingType getOriginalResultat() {
        return originalResultat;
    }

    public void setOriginalResultat(UttakPeriodeVurderingType originalResultat) {
        this.originalResultat = originalResultat;
    }
