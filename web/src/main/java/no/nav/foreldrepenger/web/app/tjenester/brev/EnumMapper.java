...
final class EnumMapper {
    ...
    static ForeldrepengerUttak.StønadskontoType mapStønadskontoType(Stønadskontotype stønadskontotype) {
        return switch (stønadskontotype) {
            case MØDREKVOTE -> ForeldrepengerUttak.StønadskontoType.MØDREKVOTE;
            case FEDREKVOTE -> ForeldrepengerUttak.StønadskontoType.FEDREKVOTE;
            case FELLESPERIODE -> ForeldrepengerUttak.StønadskontoType.FELLESPERIODE;
    ...
    static ForeldrepengerUttak.StønadskontoType mapStønadskontoType(UttakPeriodeType trekkonto) {
    ...
    static SvangerskapspengerUttak.ArbeidsforholdIkkeOppfyltÅrsak mapArbeidsforholdIkkeOppfyltÅrsak(ArbeidsforholdIkkeOppfyltÅrsak arbeidsforholdIkkeOppfyltÅrsak) {
        return switch (arbeidsforholdIkkeOppfyltÅrsak) {
            case INGEN -> SvangerskapspengerUttak.ArbeidsforholdIkkeOppfyltÅrsak.INGEN;
            case HELE_UTTAKET_ER_ETTER_3_UKER_FØR_TERMINDATO ->
                SvangerskapspengerUttak.ArbeidsforholdIkkeOppfyltÅrsak.HELE_UTTAKET_ER_ETTER_3_UKER_FØR_TERMINDATO;
            case UTTAK_KUN_PÅ_HELG -> SvangerskapspengerUttak.ArbeidsforholdIkkeOppfyltÅrsak.UTTAK_KUN_PÅ_HELG;
            case ARBEIDSGIVER_KAN_TILRETTELEGGE -> SvangerskapspengerUttak.ArbeidsforholdIkkeOppfyltÅrsak.ARBEIDSGIVER_KAN_TILRETTELEGGE;
            case ARBEIDSGIVER_KAN_TILRETTELEGGE_FREM_TIL_3_UKER_FØR_TERMIN ->
                SvangerskapspengerUttak.ArbeidsforholdIkkeOppfyltÅrsak.ARBEIDSGIVER_KAN_TILRETTELEGGE_FREM_TIL_3_UKER_FØR_TERMIN;
        };
    }
    ...
    static KlageBehandling.KlageHjemmel mapKlageHjemmel(KlageHjemmel klageHjemmel) {
        return switch (klageHjemmel) {
            case MEDLEM -> KlageBehandling.KlageHjemmel.MEDLEM;
            case SVANGERSKAP -> KlageBehandling.KlageHjemmel.SVANGERSKAP;
            case FORELDRE -> KlageBehandling.KlageHjemmel.FORELDRE;
            case OPPTJENING -> KlageBehandling.KlageHjemmel.OPPTJENING;
            case BEREGNING -> KlageBehandling.KlageHjemmel.BEREGNING;
            case DAGER -> KlageBehandling.KlageHjemmel.DAGER;
            case UTTAK -> KlageBehandling.KlageHjemmel.UTTAK;
            case UTSETTELSE -> KlageBehandling.KlageHjemmel.UTSETTELSE;
            case KVOTER -> KlageBehandling.KlageHjemmel.KVOTER;
            case AKTIVITET -> KlageBehandling.KlageHjemmel.AKTIVITET;
            case BFHR -> KlageBehandling.KlageHjemmel.BFHR;
            case FARALENE -> KlageBehandling.KlageHjemmel.FARALENE;
            case GRADERING -> KlageBehandling.KlageHjemmel.GRADERING;
            case ENGANGS -> KlageBehandling.KlageHjemmel.ENGANGS;
            case OPPTJENINGSTID -> KlageBehandling.KlageHjemmel.OPPTJENINGSTID;
            case OPPLYSNINGSPLIKT -> KlageBehandling.KlageHjemmel.OPPLYSNINGSPLIKT;
            case FREMSETT -> KlageBehandling.KlageHjemmel.FREMSETT;
            case TILBAKE -> KlageBehandling.KlageHjemmel.TILBAKE;
            case EØS_YTELSE -> KlageBehandling.KlageHjemmel.EØS_YTELSE;
            case EØS_OPPTJEN -> KlageBehandling.KlageHjemmel.EØS_OPPTJEN;
            case UDEFINERT -> KlageBehandling.KlageHjemmel.UDEFINERT;
        };
    }
    ...
    static KlageBehandling.KlageVurderingOmgjør mapKlageVurderingOmgjør(KlageVurderingOmgjør klageVurderingOmgjør) {
        return switch (klageVurderingOmgjør) {
            case GUNST_MEDHOLD_I_KLAGE -> KlageBehandling.KlageVurderingOmgjør.GUNST_MEDHOLD_I_KLAGE;
            case DELVIS_MEDHOLD_I_KLAGE -> KlageBehandling.KlageVurderingOmgjør.DELVIS_MEDHOLD_I_KLAGE;
            case UGUNST_MEDHOLD_I_KLAGE -> KlageBehandling.KlageVurderingOmgjør.UGUNST_MEDHOLD_I_KLAGE;
            case UDEFINERT -> KlageBehandling.KlageVurderingOmgjør.UDEFINERT;
        };
    }

    static KlageBehandling.KlageMedholdÅrsak mapKlageMedholdÅrsak(KlageMedholdÅrsak klageMedholdÅrsak) {
        return switch (klageMedholdÅrsak) {
            case NYE_OPPLYSNINGER -> KlageBehandling.KlageMedholdÅrsak.NYE_OPPLYSNINGER;
            case ULIK_REGELVERKSTOLKNING -> KlageBehandling.KlageMedholdÅrsak.ULIK_REGELVERKSTOLKNING;
            case ULIK_VURDERING -> KlageBehandling.KlageMedholdÅrsak.ULIK_VURDERING;
            case PROSESSUELL_FEIL -> KlageBehandling.KlageMedholdÅrsak.PROSESSUELL_FEIL;
            case UDEFINERT -> KlageBehandling.KlageMedholdÅrsak.UDEFINERT;
        };
    }

    static KlageBehandling.KlageVurdering mapKlageVurdering(KlageVurdering klageVurdering) {
        return switch (klageVurdering) {
            case OPPHEVE_YTELSESVEDTAK -> KlageBehandling.KlageVurdering.OPPHEVE_YTELSESVEDTAK;
            case STADFESTE_YTELSESVEDTAK -> KlageBehandling.KlageVurdering.STADFESTE_YTELSESVEDTAK;
            case MEDHOLD_I_KLAGE -> KlageBehandling.KlageVurdering.MEDHOLD_I_KLAGE;
            case AVVIS_KLAGE -> KlageBehandling.KlageVurdering.AVVIS_KLAGE;
            case HJEMSENDE_UTEN_Å_OPPHEVE -> KlageBehandling.KlageVurdering.HJEMSENDE_UTEN_Å_OPPHEVE;
            case UDEFINERT -> KlageBehandling.KlageVurdering.UDEFINERT;
        };
    }
    ...
    static BrevGrunnlagDto.FagsakStatus mapFagsakStatus(FagsakStatus status) {
        return switch (status) {
            case OPPRETTET -> BrevGrunnlagDto.FagsakStatus.OPPRETTET;
            case UNDER_BEHANDLING -> BrevGrunnlagDto.FagsakStatus.UNDER_BEHANDLING;
            case LØPENDE -> BrevGrunnlagDto.FagsakStatus.LØPENDE;
            case AVSLUTTET -> BrevGrunnlagDto.FagsakStatus.AVSLUTTET;
        };
    }
    ...
    static Verge.VergeType mapVergeType(VergeType vergeType) {
        return switch (vergeType) {
            case BARN -> Verge.VergeType.BARN;
            case FBARN -> Verge.VergeType.FBARN;
            case VOKSEN -> Verge.VergeType.VOKSEN;
            case ADVOKAT -> Verge.VergeType.ADVOKAT;
            case ANNEN_F -> Verge.VergeType.ANNEN_F;
        };
    }
