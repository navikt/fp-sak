...
public record InfotrygdVedtakDto(List<SakDto> saker, List<VedtakKjede> vedtakKjeder) {
    ...
    public record Vedtak(InfotrygdKode behandlingstema, LocalDate identdato, // IS10: ArbUfør
                         ...
                         List<Arbeidsforhold> arbeidsforhold, Integer dekningsgrad, // IS10: Fdato
    ...
    // Fra IS15 Utbetaling
    public record Utbetaling(Periode periode, int utbetalingsgrad, String arbeidsgiverOrgnr, Boolean erRefusjon, Integer dagsats, LocalDate identdato,
    ...
    public record SakDto(String resultat, LocalDate registrert, String sakId, String type, LocalDate vedtatt, String valg, String undervalg,
                         String nivaa) {
