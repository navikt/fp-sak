...
import no.nav.foreldrepenger.domene.rest.dto.KontrollerBesteberegningOldDto;
...
@ApplicationScoped
@DtoTilServiceAdapter(dto = KontrollerBesteberegningOldDto.class, adapter = AksjonspunktOppdaterer.class)
public class KontrollerBesteberegningOldOppdaterer implements AksjonspunktOppdaterer<KontrollerBesteberegningOldDto> {

    private HistorikkTjenesteAdapter historikkTjenesteAdapter;

    protected KontrollerBesteberegningOldOppdaterer() {
        // CDI
    }

    @Inject
    public KontrollerBesteberegningOldOppdaterer(HistorikkTjenesteAdapter historikkTjenesteAdapter) {
        this.historikkTjenesteAdapter = historikkTjenesteAdapter;
    }

    @Override
    public OppdateringResultat oppdater(KontrollerBesteberegningOldDto dto, AksjonspunktOppdaterParameter param) {
    ...
    private void lagHistorikk(KontrollerBesteberegningOldDto dto) {
