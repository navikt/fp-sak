...
public class HendelsePublisererTjenesteTest extends EntityManagerAwareTest {
    ...
    private BehandlingVedtakRepository vedtakRepo;
    ...
    public void setUp() {
        ...
        vedtakRepo = new BehandlingVedtakRepository(getEntityManager());
