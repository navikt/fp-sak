...
public class KontrollerOppgittFordelingTjenesteTest {
    ...
    public void skal_lagre_ny_endringsdato_hvis_første_dato_bekreftet_perioder_er_før_første_uttaksdato_opprinnelige_perioder() {
        ...
        BekreftetOppgittPeriodeDto bekreftetOppgittPeriodeDto = getBekreftetUttakPeriodeDto(nyDato, nyDato.plusDays(1), true);
        ...
        assertThat(ytelseFordelingAggregat.getAvklarteDatoer().get().getOpprinneligEndringsdato()).isEqualTo(opprinneligDato);
    }
