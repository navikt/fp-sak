...
class SøknadMapperTest {
    ...
    @Test
    void skalBeholdeUtsettelseNårBareFarHarRettVedFørstegangssøknad() {
        var navBruker = opprettBruker();
        ...
        tidsromPermisjon.setUtsettelsePeriode(
            List.of(opprettUtsettelseDto(uttaksstart.plusWeeks(2).plusDays(1), uttaksstart.plusWeeks(3), FORELDREPENGER)));
