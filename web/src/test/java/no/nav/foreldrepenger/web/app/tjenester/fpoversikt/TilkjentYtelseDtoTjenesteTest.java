...
class TilkjentYtelseDtoTjenesteTest {
    ...
    void skal_mappe_tilkjent_ytelse_med_flere_perioder() {
        ...
        assertThat(resultat.get(0).andeler().getFirst().aktivitetStatus()).isEqualTo(OversiktAktivitetStatus.ARBEIDSTAKER);
        ...
        assertThat(resultat.get(1).andeler().getFirst().aktivitetStatus()).isEqualTo(OversiktAktivitetStatus.ARBEIDSTAKER);
    ...
    void skal_mappe_periode_med_flere_andeler() {
        ...
        assertThat(andel1.aktivitetStatus()).isEqualTo(OversiktAktivitetStatus.ARBEIDSTAKER);
        ...
        assertThat(andel2.aktivitetStatus()).isEqualTo(OversiktAktivitetStatus.ARBEIDSTAKER);
    ...
    void skal_håndtere_andel_uten_arbeidsgiver() {
        ...
        assertThat(andel.aktivitetStatus()).isEqualTo(OversiktAktivitetStatus.FRILANSER);
