...
import no.nav.foreldrepenger.produksjonsstyring.tilbakekreving.TilbakekrevingVedtakDto;
...
class KlageFormkravOppdatererTest extends EntityManagerAwareTest {
    ...
    void skal_oppdatere_klage_aksjonspunkt_til_tilbakekreving_behandling() {
        ...
        var historikk = historikkinnslagRepository.hent(behandling.getSaksnummer())
            .stream()
            .sorted(Comparator.comparing(Historikkinnslag::getOpprettetTidspunkt))
            .toList();
