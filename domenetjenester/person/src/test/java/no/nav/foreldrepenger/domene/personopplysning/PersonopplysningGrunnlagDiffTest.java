...
class PersonopplysningGrunnlagDiffTest {
    ...
    void skal_ikke_identifisere_som_kun_endring_fødsel_dersom_ingen_diff() {
        ...
        final var oppdatert = PersonopplysningGrunnlagBuilder.oppdatere(Optional.empty());
        final var builder2 = PersonInformasjonBuilder.oppdater(Optional.empty(), PersonopplysningVersjonType.REGISTRERT);
    ...
    void skal_identifisere_som_kun_ny_fødsel_dersom_diff_kun_omfatter_etterregistrering_fødsel_annenpart() {
        ...
        final var annenPart = new OppgittAnnenPartBuilder().medAktørId(EKTEFELLE_AKTØR_ID).build();
