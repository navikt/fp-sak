...
public interface BehandlingSteg {
    ...
    /**
     * Template Method - transisjoner utover normal flyt (utførSteg) for opprydding
     * el.
     *
     * @param kontekst   - overordnet kontekst informasjon og lås for å gjøre
     *                   endringer på behandlingen.
     * @param modell     - BehandlingStegModell som kan benyttes til oppslag av
     *                   hvordan flyten skal være
     * @param førsteSteg - Det første steget av stegene det hoppes mellom. Vil være
     *                   steget det hoppes til ved bakoverhopp.
