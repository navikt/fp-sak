...
public class EngangsstønadModellProducer {
    ...
    public BehandlingModell førstegangsbehandling() {
        ...
        modellBuilder.medSteg(BehandlingStegType.REGISTRER_SØKNAD, BehandlingStegType.INNHENT_SØKNADOPP, BehandlingStegType.VURDER_KOMPLETTHET,
            BehandlingStegType.INNHENT_REGISTEROPP, BehandlingStegType.INREG_AVSL, BehandlingStegType.VURDER_FORUTGÅENDE_MEDLEMSKAPVILKÅR,
            ...
            BehandlingStegType.VURDER_MEDLEMSKAPVILKÅR, BehandlingStegType.VURDER_SØKNADSFRISTVILKÅR, BehandlingStegType.VURDER_SAMLET,
    ...
    public BehandlingModell revurdering() {
        ...
        modellBuilder.medSteg(BehandlingStegType.VARSEL_REVURDERING, BehandlingStegType.VURDER_KOMPLETTHET, BehandlingStegType.INNHENT_REGISTEROPP,
            BehandlingStegType.INREG_AVSL, BehandlingStegType.KONTROLLER_FAKTA, BehandlingStegType.KONTROLLERER_SØKERS_OPPLYSNINGSPLIKT,
            BehandlingStegType.SØKERS_RELASJON_TIL_BARN, BehandlingStegType.VURDER_MEDLEMSKAPVILKÅR, BehandlingStegType.VURDER_SØKNADSFRISTVILKÅR,
            BehandlingStegType.VURDER_SAMLET, BehandlingStegType.BEREGN_YTELSE, BehandlingStegType.FORESLÅ_BEHANDLINGSRESULTAT,
