...
public class Transisjoner {
    ...
    private static final List<StegTransisjon> ALLE_TRANSISJONER = Arrays.asList(new Startet(), new Utført(), new HenleggelseTransisjon(),
        new SettPåVent(), new TilbakeføringTransisjon(FellesTransisjoner.TILBAKEFØRT_TIL_AKSJONSPUNKT.getId()),
        ...
        new SpolFremoverTransisjon(BehandlingStegType.KONTROLLER_FAKTA), new SpolFremoverTransisjon(BehandlingStegType.DEKNINGSGRAD),
        ...
        new SpolFremoverTransisjon(BehandlingStegType.KONTROLLER_LØPENDE_MEDLEMSKAP), new SpolFremoverTransisjon(BehandlingStegType.BEREGN_YTELSE),
