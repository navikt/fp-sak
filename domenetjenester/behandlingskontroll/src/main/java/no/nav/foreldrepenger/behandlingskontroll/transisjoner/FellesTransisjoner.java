...
public class FellesTransisjoner {
    ...
    public static final TransisjonIdentifikator FREMHOPP_TIL_FORESLÅ_BEHANDLINGSRESULTAT = TransisjonIdentifikator.forId(
        FREMHOPP_PREFIX + "foreslå-behandlingsresultat");
    public static final TransisjonIdentifikator FREMHOPP_TIL_KONTROLLERER_SØKERS_OPPLYSNINGSPLIKT = TransisjonIdentifikator.forId(
        FREMHOPP_PREFIX + "kontroller-søkers-opplysningsplikt");
