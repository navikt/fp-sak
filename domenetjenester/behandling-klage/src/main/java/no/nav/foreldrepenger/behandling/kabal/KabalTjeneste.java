...
public class KabalTjeneste {
    ...
    private KlageVurdering klageVurderingFraUtfall(KabalUtfall utfall) {
        return switch (utfall) {
            ...
            case RETUR, TRUKKET, HENLAGT, HEVET, MEDHOLD_ETTER_FVL_35, GJENOPPTATT_OPPHEVET,
                 GJENOPPTATT_DELVIS_ELLER_FULLT_MEDHOLD -> throw new IllegalStateException("Utviklerfeil forsøker lagre klage med utfall " + utfall);
        };
    }
    ...
    private AnkeVurdering ankeVurderingFraUtfall(KabalUtfall utfall) {
        return switch (utfall) {
            ...
            case RETUR, TRUKKET, HENLAGT, HEVET, MEDHOLD_ETTER_FVL_35, GJENOPPTATT_OPPHEVET,
                 GJENOPPTATT_DELVIS_ELLER_FULLT_MEDHOLD -> throw new IllegalStateException("Utviklerfeil forsøker lagre anke med utfall " + utfall);
        };
    }
