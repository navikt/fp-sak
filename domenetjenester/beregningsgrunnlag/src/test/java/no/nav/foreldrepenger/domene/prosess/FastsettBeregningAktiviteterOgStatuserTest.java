...
import static no.nav.foreldrepenger.domene.prosess.mappers.fra_kalkulus.KalkulusTilBehandlingslagerMapper.mapBeregningsgrunnlag;
import static no.nav.foreldrepenger.domene.prosess.mappers.fra_kalkulus.KalkulusTilBehandlingslagerMapper.mapSaksbehandletAktivitet;
import static no.nav.foreldrepenger.domene.prosess.mappers.til_kalkulus.BehandlingslagerTilKalkulusMapper.mapSaksbehandletAktivitet;
...
import no.nav.foreldrepenger.domene.prosess.mappers.til_kalkulus.IAYMapperTilKalkulus;
import no.nav.foreldrepenger.domene.prosess.mappers.til_kalkulus.MapBehandlingRef;
import no.nav.foreldrepenger.domene.prosess.mappers.til_kalkulus.OpptjeningMapperTilKalkulus;
...
public class FastsettBeregningAktiviteterOgStatuserTest {
    ...
    public void testSkjæringstidspunktForFlereArbeidsforholdISammeVirksomhet() {
        ...
        // Act
        BeregningsgrunnlagEntitet grunnlag = act(opptjeningAktiviteter, inntektsmeldinger, opprettBehandling());
