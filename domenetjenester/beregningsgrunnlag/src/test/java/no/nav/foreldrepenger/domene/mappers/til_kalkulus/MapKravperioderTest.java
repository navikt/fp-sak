...
class MapKravperioderTest {
    ...
    void inntektsmelding_med_et_arbeidsforhold_mappes_korrekt() {
        ...
        var resultat = MapKravperioder.map(BEHANDLING_REF, STPT.getSkjæringstidspunktOpptjening(), aktiveInntektsmeldinger, byggIAY());
    ...
    void inntektsmelding_med_to_arbeidsforhold_ulike_bedrifter_mappes_korrekt() {
        ...
        var resultat = MapKravperioder.map(BEHANDLING_REF, STP, aktiveInntektsmeldinger, byggIAY());
    ...
    void gammel_og_ny_im_for_samme_arbeidsforhold() {
        ...
        var resultat = MapKravperioder.map(BEHANDLING_REF, STP, alleIMPåSak, byggIAY());
