...
import no.nav.foreldrepenger.domene.prosess.input.BeregningTilInputTjeneste;
import no.nav.foreldrepenger.domene.prosess.input.KalkulatorStegProsesseringInputTjeneste;
