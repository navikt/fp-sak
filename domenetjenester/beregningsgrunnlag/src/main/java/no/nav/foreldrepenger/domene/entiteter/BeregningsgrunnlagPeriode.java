...
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagPeriodeRegelType.FASTSETT;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagPeriodeRegelType.FINN_GRENSEVERDI;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagPeriodeRegelType.FORDEL;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagPeriodeRegelType.FORESLÅ;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagPeriodeRegelType.OPPDATER_GRUNNLAG_SVP;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagPeriodeRegelType.VILKÅR_VURDERING;
