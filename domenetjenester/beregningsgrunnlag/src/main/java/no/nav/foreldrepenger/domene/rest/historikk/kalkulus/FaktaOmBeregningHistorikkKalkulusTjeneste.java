 ...
 */
@Dependent
public class FaktaOmBeregningHistorikkKalkulusTjeneste {
    ...
    public FaktaOmBeregningHistorikkKalkulusTjeneste() {
        // CDI
    }

    @Inject
    public FaktaOmBeregningHistorikkKalkulusTjeneste(HistorikkTjenesteAdapter historikkAdapter,
