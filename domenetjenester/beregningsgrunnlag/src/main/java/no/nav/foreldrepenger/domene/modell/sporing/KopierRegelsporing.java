package no.nav.foreldrepenger.domene.modell.sporing;
...
import no.nav.foreldrepenger.domene.modell.BeregningsgrunnlagPeriodeRegelSporing;
import no.nav.foreldrepenger.domene.modell.BeregningsgrunnlagRegelSporing;
import no.nav.foreldrepenger.domene.modell.BeregningsgrunnlagRegelType;
