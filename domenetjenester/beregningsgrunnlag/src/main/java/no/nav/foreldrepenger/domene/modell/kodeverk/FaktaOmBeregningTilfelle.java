...
public enum FaktaOmBeregningTilfelle implements Kodeverdi {
    ...
    FASTSETT_BG_ARBEIDSTAKER_UTEN_INNTEKTSMELDING("FASTSETT_BG_ARBEIDSTAKER_UTEN_INNTEKTSMELDING",
        "Fastsette beregningsgrunnlag for arbeidstaker uten inntektsmelding"),
    ...
    FASTSETT_MÅNEDSLØNN_ARBEIDSTAKER_UTEN_INNTEKTSMELDING("FASTSETT_MÅNEDSLØNN_ARBEIDSTAKER_UTEN_INNTEKTSMELDING",
        "Fastsett månedslønn arbeidstaker uten inntektsmelding"),
    VURDER_AT_OG_FL_I_SAMME_ORGANISASJON("VURDER_AT_OG_FL_I_SAMME_ORGANISASJON",
        "Vurder om bruker er arbeidstaker og frilanser i samme organisasjon"),
    ...
    VURDER_REFUSJONSKRAV_SOM_HAR_KOMMET_FOR_SENT("VURDER_REFUSJONSKRAV_SOM_HAR_KOMMET_FOR_SENT",
        "Vurder refusjonskrav fremsatt for sent skal være med i beregning."),
