...
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagTilstand.BESTEBEREGNET;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagTilstand.FASTSATT;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagTilstand.FASTSATT_INN;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagTilstand.FORESLÅTT;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagTilstand.FORESLÅTT_UT;
...
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagTilstand.OPPDATERT_MED_REFUSJON_OG_GRADERING;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagTilstand.VURDERT_REFUSJON;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagTilstand.VURDERT_VILKÅR;
