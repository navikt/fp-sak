...
public class MatchBeregningsgrunnlagTjeneste {
    ...
    public static Optional<BeregningsgrunnlagPeriode> finnOverlappendePeriodeOmKunEnFinnes(BeregningsgrunnlagPeriode periode,
        ...
        var matchedePerioder = forrigeGrunnlag.map(bg -> bg.getBeregningsgrunnlagPerioder()
            .stream()
            .filter(periodeIGjeldendeGrunnlag -> periode.getPeriode().overlapper(periodeIGjeldendeGrunnlag.getPeriode()))
    ...
    public static BeregningsgrunnlagPeriode finnPeriodeIBeregningsgrunnlag(BeregningsgrunnlagPeriode periode,
                                                                           BeregningsgrunnlagEntitet gjeldendeBeregningsgrunnlag) {

        if (periode.getBeregningsgrunnlagPeriodeFom().isBefore(gjeldendeBeregningsgrunnlag.getSkjæringstidspunkt())) {
            return gjeldendeBeregningsgrunnlag.getBeregningsgrunnlagPerioder()
                .stream()
    ...
    private static boolean inkludererBeregningsgrunnlagPeriodeDato(BeregningsgrunnlagPeriode periode, LocalDate dato) {
        return !periode.getBeregningsgrunnlagPeriodeFom().isAfter(dato) && (periode.getBeregningsgrunnlagPeriodeTom() == null
            || !periode.getBeregningsgrunnlagPeriodeTom().isBefore(dato));
    }
