...
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagRegelType.BRUKERS_STATUS;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagRegelType.PERIODISERING;
import static no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagRegelType.SKJÆRINGSTIDSPUNKT;
