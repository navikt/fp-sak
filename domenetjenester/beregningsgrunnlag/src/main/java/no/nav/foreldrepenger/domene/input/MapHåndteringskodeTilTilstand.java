...
public final class MapHåndteringskodeTilTilstand {
    ...
    static {
        ...
        MAP.put(AksjonspunktDefinisjon.FASTSETT_BEREGNINGSGRUNNLAG_SELVSTENDIG_NÆRINGSDRIVENDE, BeregningsgrunnlagTilstand.FORESLÅTT_UT);
        MAP.put(AksjonspunktDefinisjon.FASTSETT_BEREGNINGSGRUNNLAG_FOR_SN_NY_I_ARBEIDSLIVET, BeregningsgrunnlagTilstand.FORESLÅTT_UT);
        ...
        MAP.put(AksjonspunktDefinisjon.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NÆRING_SELVSTENDIG_NÆRINGSDRIVENDE, BeregningsgrunnlagTilstand.FORESLÅTT_UT);
