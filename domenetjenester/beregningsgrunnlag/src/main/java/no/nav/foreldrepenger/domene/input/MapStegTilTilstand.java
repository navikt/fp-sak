...
public final class MapStegTilTilstand {
    ...
    static {
        STEG_TILSTAND.put(BehandlingStegType.KONTROLLER_FAKTA_BEREGNING, BeregningsgrunnlagTilstand.OPPDATERT_MED_ANDELER);
        ...
        STEG_TILSTAND.put(BehandlingStegType.FORDEL_BEREGNINGSGRUNNLAG, BeregningsgrunnlagTilstand.OPPDATERT_MED_REFUSJON_OG_GRADERING);
