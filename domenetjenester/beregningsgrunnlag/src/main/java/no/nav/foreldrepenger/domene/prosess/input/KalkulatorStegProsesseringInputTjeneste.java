package no.nav.foreldrepenger.domene.prosess.input;

import static no.nav.foreldrepenger.domene.prosess.input.MapStegTilTilstand.mapTilKalkulatorStegTilstand;
import static no.nav.foreldrepenger.domene.prosess.input.MapStegTilTilstand.mapTilKalkulatorStegUtTilstand;
import static no.nav.foreldrepenger.domene.prosess.input.MapStegTilTilstand.mapTilStegTilstand;
import static no.nav.foreldrepenger.domene.prosess.input.MapStegTilTilstand.mapTilStegUtTilstand;
...
import no.nav.foreldrepenger.domene.prosess.mappers.til_kalkulus.BehandlingslagerTilKalkulusMapper;
