...
public class UtledPermisjonSomFørerTilAksjonspunktTest {
    ...
    public void skal_ikke_filtrere_ut_permisjon_selv_med_flere_yrkesaktivteter_med_arbeidtype_fra_aareg() {
        ...
        // Arrange
        LocalDate stp = getSkjæringstidspunkt();

        yrkesaktivitetBuilder = aktørArbeidBuilder.getYrkesaktivitetBuilderForNøkkelAvType(new Opptjeningsnøkkel(
                InternArbeidsforholdRef.nyRef(), null, null), ArbeidType.ORDINÆRT_ARBEIDSFORHOLD);
        Permisjon permisjon_1 = byggPermisjon(DAGENS_DATO.minusYears(5), DAGENS_DATO.plusYears(1), PermisjonsbeskrivelseType.PERMISJON,
        ...
        Permisjon permisjon_2 = byggPermisjon(DAGENS_DATO.minusYears(4), DAGENS_DATO.plusYears(1), PermisjonsbeskrivelseType.PERMITTERING,
        ...
        Permisjon permisjon_3 = byggPermisjon(DAGENS_DATO.minusYears(3), DAGENS_DATO.plusYears(1), PermisjonsbeskrivelseType.VELFERDSPERMISJON,
        ...
        // Act
        List<PermisjonDto> permisjoner = UtledPermisjonSomFørerTilAksjonspunkt.utled(new YrkesaktivitetFilter(null, yrkesaktiviteter),
    ...
    public void skal_filtrere_ut_permisjon_hvis_arbeidstype_ikke_er_fra_aareg() {
        // Arrange
        LocalDate stp = getSkjæringstidspunkt();
        Permisjon permisjon = byggPermisjon(DAGENS_DATO.minusYears(1), DAGENS_DATO.plusMonths(6), PermisjonsbeskrivelseType.PERMISJON,
                BigDecimal.valueOf(100));
    ...
    public void skal_filtrere_ut_permisjon_som_slutter_før_stp() {
        // Arrange
        Permisjon permisjon = byggPermisjon(DAGENS_DATO.minusMonths(6), DAGENS_DATO.minusDays(1), PermisjonsbeskrivelseType.PERMISJON,
                BigDecimal.valueOf(100));
        AktivitetsAvtaleBuilder aktivitetsAvtale = byggAktivitetsAvtale(DAGENS_DATO.minusYears(3), DAGENS_DATO.plusYears(1));
        Yrkesaktivitet yrkesaktivitet = byggYrkesAktivitet(permisjon, aktivitetsAvtale, "123", ArbeidType.ORDINÆRT_ARBEIDSFORHOLD);
        yrkesaktiviteter.add(yrkesaktivitet);
    ...
    public void skal_filtrere_ut_permisjon_av_type_UTDANNINGSPERMISJON() {
        // Arrange
        LocalDate stp = getSkjæringstidspunkt();
        Permisjon permisjon = byggPermisjon(DAGENS_DATO.minusYears(1), DAGENS_DATO.plusMonths(6), PermisjonsbeskrivelseType.UTDANNINGSPERMISJON,
                BigDecimal.valueOf(100));
        AktivitetsAvtaleBuilder aktivitetsAvtale = byggAktivitetsAvtale(DAGENS_DATO.minusYears(3), DAGENS_DATO.plusYears(1));
        Yrkesaktivitet yrkesaktivitet = byggYrkesAktivitet(permisjon, aktivitetsAvtale, "123", ArbeidType.ORDINÆRT_ARBEIDSFORHOLD);
        yrkesaktiviteter.add(yrkesaktivitet);
    ...
    public void skal_filtrere_ut_permisjon_av_type_PERMISJON_MED_FORELDREPENGER() {
        // Arrange
        LocalDate stp = getSkjæringstidspunkt();
        Permisjon permisjon = byggPermisjon(DAGENS_DATO.minusYears(1), DAGENS_DATO.plusMonths(6),
