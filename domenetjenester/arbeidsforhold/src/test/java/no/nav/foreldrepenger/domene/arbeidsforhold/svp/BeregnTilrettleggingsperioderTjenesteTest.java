...
public class BeregnTilrettleggingsperioderTjenesteTest {
    ...
    public void skal_beregne_perioder_riktig_ved_to_arbeidsforhold_i_samme_bedrift() {
        ...
        TilretteleggingMedUtbelingsgrad arb1 = tilretteleggingMedUtbelingsgrad.stream()
                .filter(t -> t.getTilretteleggingArbeidsforhold().getInternArbeidsforholdRef().gjelderFor(ARB_1)).findFirst().get();
        TilretteleggingMedUtbelingsgrad arb2 = tilretteleggingMedUtbelingsgrad.stream()
    ...
    private void lagAktørArbeidMed2ArbeidsforholdIsammeVirksomhet(InntektArbeidYtelseAggregatBuilder inntektArbeidYtelseAggregatBuilder,
        ...
        YrkesaktivitetBuilder yrkesaktivitetBuilder1 = aktørArbeidBuilder.getYrkesaktivitetBuilderForNøkkelAvType(opptjeningsnøkkel,
                ArbeidType.ORDINÆRT_ARBEIDSFORHOLD);
        AktivitetsAvtaleBuilder aktivitetsAvtaleBuilder1 = yrkesaktivitetBuilder1
        ...
        AktivitetsAvtaleBuilder prosent1 = yrkesaktivitetBuilder1
        ...
        YrkesaktivitetBuilder yrkesaktivitetBuilder2 = aktørArbeidBuilder.getYrkesaktivitetBuilderForNøkkelAvType(opptjeningsnøkkel,
                ArbeidType.ORDINÆRT_ARBEIDSFORHOLD);
        AktivitetsAvtaleBuilder aktivitetsAvtaleBuilder2 = yrkesaktivitetBuilder2
        ...
        AktivitetsAvtaleBuilder prosent2 = yrkesaktivitetBuilder2
