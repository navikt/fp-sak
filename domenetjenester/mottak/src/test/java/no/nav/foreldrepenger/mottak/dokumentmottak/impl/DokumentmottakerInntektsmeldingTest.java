...
public class DokumentmottakerInntektsmeldingTest {
    ...
    public void skal_lage_ny_førstegangsbehandling_med_inntektsmeldingen_etter_henlagt_førstegangsbehandling() {
        ...
        doReturn(behandling).when(behandlingsoppretter).opprettFørstegangsbehandling(any(Fagsak.class), any(BehandlingÅrsakType.class), any(Optional.class));

        // Act
        dokumentmottaker.opprettFraTidligereAvsluttetBehandling(behandling.getFagsak(), behandling.getId(), mottattDokument, BehandlingÅrsakType.UDEFINERT, false);
    ...
    public void skal_ikke_lage_ny_førstegangsbehandling_med_inntektsmeldingen_når_det_finnes_en_åpen_behandling() {
        ...
        // Assert
        verify(behandlingsoppretter, times(0)).opprettFørstegangsbehandling(behandling.getFagsak(), BehandlingÅrsakType.RE_ENDRET_INNTEKTSMELDING, Optional.of(behandling));
    }
