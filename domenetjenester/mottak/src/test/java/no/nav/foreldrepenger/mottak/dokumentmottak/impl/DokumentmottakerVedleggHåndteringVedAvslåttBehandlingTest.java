...
class DokumentmottakerVedleggHåndteringVedAvslåttBehandlingTest extends DokumentmottakerTestsupport {
    ...
    void setUp() {
        ...
        dokumentmottakerVedlegg = new DokumentmottakerVedlegg(behandlingRevurderingTjeneste, dokumentmottakerFellesSpied, kompletthetskontroller,
    ...
    void gittAvslåttBehandlingPgaManglendeDokMedUtløptFristForInnsendingSkalOppretteTaskForÅVurdereDokument() {
        ...
        // Assert
        Mockito.verify(dokumentmottakerFellesSpied, Mockito.never())
            .opprettFørstegangsbehandlingMedHistorikkinslagOgKopiAvDokumenter(Mockito.any(), Mockito.any(), Mockito.any());
