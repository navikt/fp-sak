...
public class VedtaksbrevUtlederTest {
    ...
    KlageVurderingResultat klageVurderingResultat = Mockito.mock(KlageVurderingResultat.class);
    ...
    public void skal_velge_riktig_klagemal() {
        ...
        assertThat(VedtaksbrevUtleder.velgKlagemal(behandling, klageRepository,fakeUnleash)).isEqualTo(DokumentMalType.KLAGE_YTELSESVEDTAK_STADFESTET_DOK);

        doReturn(KlageVurdering.AVVIS_KLAGE).when(klageVurderingResultat).getKlageVurdering();
        assertThat(VedtaksbrevUtleder.velgKlagemal(behandling, klageRepository,fakeUnleash)).isEqualTo(DokumentMalType.KLAGE_AVVIST_DOK);

        doReturn(KlageVurdering.OPPHEVE_YTELSESVEDTAK).when(klageVurderingResultat).getKlageVurdering();
        assertThat(VedtaksbrevUtleder.velgKlagemal(behandling, klageRepository,fakeUnleash)).isEqualTo(DokumentMalType.KLAGE_YTELSESVEDTAK_OPPHEVET_DOK);

        doReturn(KlageVurdering.MEDHOLD_I_KLAGE).when(klageVurderingResultat).getKlageVurdering();
        assertThat(VedtaksbrevUtleder.velgKlagemal(behandling, klageRepository,fakeUnleash)).isEqualTo(DokumentMalType.VEDTAK_MEDHOLD);
    }
