...
public class InnvilgelseFpLanseringTjeneste {
    ...
    @Inject
    public InnvilgelseFpLanseringTjeneste(FamilieHendelseRepository familieHendelseRepository,
    ...
    public DokumentMalType velgFpInnvilgelsesmalProd(Behandling behandling) {
        boolean lansertDokGen = !harDødtBarn(behandling) && harSøknadMedSpråkkodeNB(behandling);
