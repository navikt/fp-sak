...
import no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagPeriodeRegelType;
import no.nav.foreldrepenger.domene.entiteter.BeregningsgrunnlagPrStatusOgAndel;
import no.nav.foreldrepenger.domene.entiteter.PeriodeÅrsak;
...
public class VedtakXmlTest {
    ...
    private BeregningsgrunnlagAktivitetStatus buildBgAktivitetStatus(BeregningsgrunnlagEntitet beregningsgrunnlag) {
        return BeregningsgrunnlagAktivitetStatus.builder()
                .medAktivitetStatus(no.nav.foreldrepenger.domene.entiteter.AktivitetStatus.SELVSTENDIG_NÆRINGSDRIVENDE)
                .build(beregningsgrunnlag);
    }
