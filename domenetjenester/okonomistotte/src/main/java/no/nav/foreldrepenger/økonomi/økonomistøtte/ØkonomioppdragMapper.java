...
public class ØkonomioppdragMapper {
    ...
    private no.nav.foreldrepenger.integrasjon.økonomistøtte.oppdrag.Avstemming115 mapAvstemming115(Avstemming115 okoAvstemming115) {
        ...
        avstemming115.setNokkelAvstemming(okoAvstemming115.getNokkelAvstemming());
        avstemming115.setTidspktMelding(okoAvstemming115.getTidspnktMelding());
