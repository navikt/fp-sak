...
public class OppdragskontrollFeriepengerTestUtil {
    ...
    public static void verifiserOpp150NårEndringGjelderEttFeriepengeår(List<Oppdragslinje150> opp150ForrigeFeriepengerListe, List<Oppdragslinje150> opp150RevurderingFeriepengerListe,
    ...
    public static void verifiserOppdr150MedEttFeriepengeårKunIRevurdering(List<Oppdragslinje150> opp150RevurderingFeriepengerListe, boolean gjelderFørsteÅr) {
    ...
    public static void verifiserOppdr150NårDetIkkeErFeriepengerIRevurdering(Oppdragskontroll forrigeOppdrag, Oppdragskontroll oppdragRevurdering, boolean erOpphørPåFørsteÅr) {
    ...
    public static void verifiserOppdr150NårEttFeriepengeårSkalOpphøre(List<Oppdragslinje150> opp150FeriepengerListe, List<Oppdragslinje150> opp150RevurderingFeriepengerListe,
    ...
    public static void verifiserOpp150NårEttFPÅretOpphørerOgAndreIkkeEndrerSeg(List<Oppdragslinje150> opp150FeriepengerListe, List<Oppdragslinje150> opp150RevurderingFeriepengerListe,
    ...
    public static void verifiserOppdr150NårDetErEndringForToFeriepengeår(List<Oppdragslinje150> forrigeOpp150FeriepengerListe, List<Oppdragslinje150> opp150RevurderingFeriepengerListe) {
        assertThat(opp150RevurderingFeriepengerListe).allSatisfy(opp150 -> {
    ...
    public static void verifiserRefDelytelseId(List<Oppdragslinje150> opp150FeriepengerListe, List<Oppdragslinje150> opp150RevurderingFeriepengerListe, boolean skalFørsteÅrKjedes) {
    ...
    public static List<Oppdragslinje150> getOppdr150ForFeriepengerForEnMottaker(List<Oppdragslinje150> forrigeOpp150FeriepengerListe, boolean erBrukerMottaker) {
