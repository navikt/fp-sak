...
public class ØkonomioppdragMapperTest {
    ...
    private void verifyMapVedtaksDataToOppdrag(List<Oppdrag110> oppdrag110Liste, boolean gjelderFP) {
        ...
        for (Oppdrag110 oppdrag110 : oppdrag110Liste) {
            ...
            assertThat(avstemming115Generert.getKodeKomponent()).isEqualTo(oppdrag110.getAvstemming115().getKodekomponent());
            assertThat(avstemming115Generert.getNokkelAvstemming()).isEqualTo(oppdrag110.getAvstemming115().getNokkelAvstemming());
            assertThat(avstemming115Generert.getTidspktMelding()).isEqualTo(oppdrag110.getAvstemming115().getTidspnktMelding());
