...
class OppdragKjedeTest {
    ...
    void skal_konvertere_enkel_kjede_til_ytelse() {
        var kjede = OppdragKjede.builder()
            .medOppdragslinje(
                OppdragLinje.builder().medPeriode(p1).medSats(Satsen.dagsats(1000)).medDelytelseId(DelytelseId.parse("FOO001001")).build())
            .medOppdragslinje(OppdragLinje.builder()
                .medPeriode(p2)
                .medSats(Satsen.dagsats(2000))
                .medDelytelseId(DelytelseId.parse("FOO001002"))
                .medRefDelytelseId(DelytelseId.parse("FOO001001"))
                .build())
            .medOppdragslinje(OppdragLinje.builder()
                .medPeriode(p3)
                .medSats(Satsen.dagsats(1100))
                .medDelytelseId(DelytelseId.parse("FOO001003"))
                .medRefDelytelseId(DelytelseId.parse("FOO001002"))
                .build())
            .build();

        assertThat(kjede.tilYtelse().getPerioder()).containsExactly(new YtelsePeriode(p1, Satsen.dagsats(1000)),
            new YtelsePeriode(p2, Satsen.dagsats(2000)), new YtelsePeriode(p3, Satsen.dagsats(1100)));
    }
    ...
    void skal_konvertere_kjede_med_opphør_inne_i_linje_til_ytelse() {
        var kjede = OppdragKjede.builder()
            ...
            .medOppdragslinje(OppdragLinje.builder()
                ...
                .medSats(Satsen.dagsats(1100))
                .medDelytelseId(DelytelseId.parse("FOO001003"))
                .medOpphørFomDato(p2.getFom().plusDays(3))
                .build())
            .build();
    ...
    void identisk_tidsperiode_skal_overskrive_tidligere_verdi_i_samme_tidsperiode() {
        ...
        assertThat(kjede.tilYtelse().getPerioder()).containsExactly(new YtelsePeriode(p1, Satsen.dagsats(1100)));
    }
    ...
    void skal_ha_at_oppdragslinjer_implisitt_opphører_det_som_har_senere_periode() {
        ...
        var kjede = OppdragKjede.builder()
            .medOppdragslinje(
                OppdragLinje.builder().medPeriode(p2).medSats(Satsen.dagsats(1000)).medDelytelseId(DelytelseId.parse("FOO001001")).build())
            .medOppdragslinje(OppdragLinje.builder()
                .medPeriode(p3)
                .medSats(Satsen.dagsats(2000))
                .medDelytelseId(DelytelseId.parse("FOO001002"))
    ...
    void skal_kreve_at_oppdragslinjer_i_kjeden_peker_på_hverandre() {
        ...
        assertThat(exception.getMessage()).isEqualTo(
            "Oppdragslinje med delytelseId FOO001002 er ikke først i kjeden, og må referere til forrige oppdragslinje (delytelseId FOO001001)");
    }
    ...
    void skal_ikke_kreve_at_oppdragslinje_peker_på_forrige_når_alt_tidligere_er_opphørt() {
        var kjede = OppdragKjede.builder()
            ...
            .medOppdragslinje(OppdragLinje.builder()
                ...
                .medDelytelseId(DelytelseId.parse("FOO001001"))
                .medOpphørFomDato(p1.getFom())
                .build())
            .medOppdragslinje(
                OppdragLinje.builder().medPeriode(p2).medSats(Satsen.dagsats(2000)).medDelytelseId(DelytelseId.parse("FOO001002")).build())
            .build();
