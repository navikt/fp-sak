...
class OppdragskontrollTestVerktøy {
    ...
    static void verifiserAvstemming115(Oppdragskontroll oppdragRevurdering) {
        ...
        assertThat(avstemming115RevurdList).isNotEmpty();
        assertThat(avstemming115RevurdList).hasSameSizeAs(oppdragRevurdering.getOppdrag110Liste());
        for (Avstemming115 avstemming115Revurd : avstemming115RevurdList) {
            assertThat(avstemming115Revurd.getKodekomponent()).isEqualTo(ØkonomiKodekomponent.VLFP.getKodekomponent());
        }
    }
