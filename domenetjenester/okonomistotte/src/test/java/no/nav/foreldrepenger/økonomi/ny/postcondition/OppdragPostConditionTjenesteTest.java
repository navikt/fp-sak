...
public class OppdragPostConditionTjenesteTest {
    ...
    public void skal_ikke_finne_differanse_mellom_identiske_ytelser() {
        assertThat(OppdragPostConditionTjeneste.finnDifferanse(Ytelse.EMPTY, Ytelse.EMPTY)).isEmpty();
    }
    ...
    public void skal_ignorere_helger_for_satstype_dagsats() {
        ...
        Ytelse ytelseSplittet = Ytelse.builder().leggTilPeriode(
            ...
            .build();
        assertThat(OppdragPostConditionTjeneste.finnDifferanse(ytelseKontinuerlig, ytelseSplittet)).isEmpty();
        assertThat(OppdragPostConditionTjeneste.finnDifferanse(ytelseSplittet, ytelseKontinuerlig)).isEmpty();
    }
    ...
    public void skal_finne_differanse() {
        ...
        assertThat(OppdragPostConditionTjeneste.finnDifferanse(Ytelse.EMPTY, ytelse1)).contains(new OppdragPostConditionTjeneste.TilkjentYtelseDifferanse(mandag, null, 100));
        assertThat(OppdragPostConditionTjeneste.finnDifferanse(ytelse1, Ytelse.EMPTY)).contains(new OppdragPostConditionTjeneste.TilkjentYtelseDifferanse(mandag, null, -100));
        ...
        assertThat(OppdragPostConditionTjeneste.finnDifferanse(ytelse1SøndagSøndag, ytelse2SøndagSøndag)).contains(new OppdragPostConditionTjeneste.TilkjentYtelseDifferanse(mandag, null, 500));
        assertThat(OppdragPostConditionTjeneste.finnDifferanse(ytelse2SøndagSøndag, ytelse1SøndagSøndag)).contains(new OppdragPostConditionTjeneste.TilkjentYtelseDifferanse(mandag, null, -500));
        ...
        assertThat(OppdragPostConditionTjeneste.finnDifferanse(ytelseUke1, ytelseUke1OgNesteMandag)).contains(new OppdragPostConditionTjeneste.TilkjentYtelseDifferanse(nesteMandag, null, 100));
        assertThat(OppdragPostConditionTjeneste.finnDifferanse(ytelseUke1OgNesteMandag, ytelseUke1)).contains(new OppdragPostConditionTjeneste.TilkjentYtelseDifferanse(nesteMandag, null, -100));
    }
}
