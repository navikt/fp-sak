...
public class SendInformasjonsbrevOppholdBatchTjeneste implements BatchTjeneste {
    ...
    public String launch(BatchArguments arguments) {
        ...
        var saker = informasjonssakRepository.finnSakerMedMinsteInnvilgetOppholdperiodeInnenIntervall(batchArguments.getFom(),
        ...
        saker.forEach(sak -> {
            ...
            data.setNesteKjøringEtter(LocalDateTime.of(LocalDate.now(), baseline.plusSeconds(LocalDateTime.now().getNano() % 179)));
