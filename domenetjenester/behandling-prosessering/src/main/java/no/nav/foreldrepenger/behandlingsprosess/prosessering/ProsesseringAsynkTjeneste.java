...
public interface ProsesseringAsynkTjeneste {
     ...
     */
    String asynkStartBehandlingProsess(Behandling behandling);
     ...
     * @return gruppe assignet til prosess task
     */
    String asynkProsesserBehandlingMergeGruppe(Behandling behandling);
