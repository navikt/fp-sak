...
public class UttakResultatHolderImplTest {

    @Test
    public void skal_returnere_false_når_det_ikke_er_noe_uttaksresultat() {
        // Arrange
        UttakResultatHolderImpl uttakResultatHolder = new UttakResultatHolderImpl(Optional.empty());
    ...
    public void skal_returnere_true_når_alle_arbeidsforholdene_er_avslått() {
        ...
        SvangerskapspengerUttakResultatEntitet uttakResultat = new SvangerskapspengerUttakResultatEntitet.Builder(mock(Behandlingsresultat.class))
            ...
            .build();
        UttakResultatHolderImpl uttakResultatHolder = new UttakResultatHolderImpl(Optional.of(uttakResultat));
