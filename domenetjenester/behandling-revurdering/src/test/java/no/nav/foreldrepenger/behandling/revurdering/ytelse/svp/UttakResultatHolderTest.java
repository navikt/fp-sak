...
class UttakResultatHolderTest {
    ...
    void skal_returnere_true_når_alle_arbeidsforholdene_er_avslått() {
        ...
        var arbeidsforhold1 = new SvangerskapspengerUttakResultatArbeidsforholdEntitet.Builder().medArbeidsforholdIkkeOppfyltÅrsak(
            ArbeidsforholdIkkeOppfyltÅrsak.UTTAK_KUN_PÅ_HELG).build();
        var arbeidsforhold2 = new SvangerskapspengerUttakResultatArbeidsforholdEntitet.Builder().medArbeidsforholdIkkeOppfyltÅrsak(
            ArbeidsforholdIkkeOppfyltÅrsak.ARBEIDSGIVER_KAN_TILRETTELEGGE).build();

        var uttakResultat = new SvangerskapspengerUttakResultatEntitet.Builder(mock(Behandlingsresultat.class)).medUttakResultatArbeidsforhold(
            arbeidsforhold1).medUttakResultatArbeidsforhold(arbeidsforhold2).build();
