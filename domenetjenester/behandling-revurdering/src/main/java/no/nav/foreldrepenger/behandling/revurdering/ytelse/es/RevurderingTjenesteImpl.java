...
public class RevurderingTjenesteImpl implements RevurderingTjeneste {
    ...
    private Behandling opprettRevurdering(Fagsak fagsak, BehandlingÅrsakType revurderingÅrsakType, boolean manueltOpprettet, Optional<OrganisasjonsEnhet> enhet) {
        ...
        Behandling revurderingBehandling = revurderingTjenesteFelles.opprettRevurderingsbehandling(revurderingÅrsakType, opprinneligBehandling, manueltOpprettet, enhet);
