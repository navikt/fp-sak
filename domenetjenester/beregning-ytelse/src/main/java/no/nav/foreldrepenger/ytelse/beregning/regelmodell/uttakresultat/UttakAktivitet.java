...
public record UttakAktivitet(BigDecimal stillingsgrad, BigDecimal arbeidstidsprosent, BigDecimal utbetalingsgrad,
                             boolean reduserDagsatsMedUtbetalingsgrad, Arbeidsforhold arbeidsforhold, AktivitetStatus aktivitetStatus,
                             boolean erGradering, BigDecimal totalStillingsgradHosAG) {
    ...
    public UttakAktivitet medArbeidsforhold(Arbeidsforhold arbeidsforhold) {
        return new UttakAktivitet(stillingsgrad(), arbeidstidsprosent(), utbetalingsgrad(), reduserDagsatsMedUtbetalingsgrad(), arbeidsforhold,
            aktivitetStatus(), erGradering(), totalStillingsgradHosAG());
    }
