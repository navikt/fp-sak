...
public record BeregningsgrunnlagPrStatus(AktivitetStatus aktivitetStatus, List<BeregningsgrunnlagPrArbeidsforhold> arbeidsforhold,
                                         BigDecimal redusertBrukersAndelPrÅr, Inntektskategori inntektskategori) {
