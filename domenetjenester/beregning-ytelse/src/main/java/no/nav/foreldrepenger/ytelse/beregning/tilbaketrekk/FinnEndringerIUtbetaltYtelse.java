...
class FinnEndringerIUtbetaltYtelse {
    ...
    static List<EndringIBeregningsresultat> finnEndringer(List<BeregningsresultatAndel> originaleAndeler,
    ...
    private static List<EndringIBeregningsresultat> finnEndringerForAndelerSomErAT(List<BRNøkkelMedAndeler> originaleAndelerSortertPåNøkkel,
                                                                                   BRNøkkelMedAndeler revurderingNøkkelMedAndeler) {
        var originaleAndelerMedSammeNøkkel = finnSammenligningsandelMedSammeNøkkel(revurderingNøkkelMedAndeler.getNøkkel(),
            originaleAndelerSortertPåNøkkel);
        // Nøkkelen er ny, og vi har ingen andeler å overføre fra
        return originaleAndelerMedSammeNøkkel.map(
                andelerMedSammeNøkkel -> Omfordelingstjeneste.omfordel(andelerMedSammeNøkkel, revurderingNøkkelMedAndeler))
