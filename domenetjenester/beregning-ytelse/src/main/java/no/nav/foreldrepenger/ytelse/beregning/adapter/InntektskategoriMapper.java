...
final class InntektskategoriMapper {
    ...
    private static final Map<no.nav.foreldrepenger.ytelse.beregning.regelmodell.beregningsgrunnlag.Inntektskategori, Inntektskategori> REGEL_TIL_VL_MAP = Map.ofEntries(
        ...
        Map.entry(no.nav.foreldrepenger.ytelse.beregning.regelmodell.beregningsgrunnlag.Inntektskategori.SELVSTENDIG_NÆRINGSDRIVENDE,
        ...
        Map.entry(no.nav.foreldrepenger.ytelse.beregning.regelmodell.beregningsgrunnlag.Inntektskategori.ARBEIDSAVKLARINGSPENGER,
        ...
        Map.entry(no.nav.foreldrepenger.ytelse.beregning.regelmodell.beregningsgrunnlag.Inntektskategori.ARBEIDSTAKER_UTEN_FERIEPENGER,
    ...
    private static final Map<no.nav.foreldrepenger.domene.modell.kodeverk.Inntektskategori, Inntektskategori> DOMENE_TIL_VL_MAP = Map.ofEntries(
        ...
        Map.entry(no.nav.foreldrepenger.domene.modell.kodeverk.Inntektskategori.SELVSTENDIG_NÆRINGSDRIVENDE,
            Inntektskategori.SELVSTENDIG_NÆRINGSDRIVENDE),
        ...
        Map.entry(no.nav.foreldrepenger.domene.modell.kodeverk.Inntektskategori.ARBEIDSTAKER_UTEN_FERIEPENGER,
            Inntektskategori.ARBEIDSTAKER_UTEN_FERIEPENGER));
    ...
    static no.nav.foreldrepenger.ytelse.beregning.regelmodell.beregningsgrunnlag.Inntektskategori fraVLTilRegel(no.nav.foreldrepenger.domene.modell.kodeverk.Inntektskategori inntektskategori) {
        ...
        return VL_TIL_REGEL_MAP.getOrDefault(behandlingslagerIK,
            no.nav.foreldrepenger.ytelse.beregning.regelmodell.beregningsgrunnlag.Inntektskategori.UDEFINERT);
    }
}
