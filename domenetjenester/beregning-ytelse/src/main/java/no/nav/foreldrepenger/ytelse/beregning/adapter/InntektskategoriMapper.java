...
final class InntektskategoriMapper {
    ...
    private static final Map<no.nav.foreldrepenger.domene.modell.Inntektskategori, Inntektskategori> DOMENE_TIL_VL_MAP = Map.ofEntries(
        Map.entry(no.nav.foreldrepenger.domene.modell.Inntektskategori.ARBEIDSTAKER, Inntektskategori.ARBEIDSTAKER),
        Map.entry(no.nav.foreldrepenger.domene.modell.Inntektskategori.FRILANSER, Inntektskategori.FRILANSER),
        Map.entry(no.nav.foreldrepenger.domene.modell.Inntektskategori.SELVSTENDIG_NÆRINGSDRIVENDE, Inntektskategori.SELVSTENDIG_NÆRINGSDRIVENDE),
        Map.entry(no.nav.foreldrepenger.domene.modell.Inntektskategori.DAGPENGER, Inntektskategori.DAGPENGER),
        Map.entry(no.nav.foreldrepenger.domene.modell.Inntektskategori.ARBEIDSAVKLARINGSPENGER, Inntektskategori.ARBEIDSAVKLARINGSPENGER),
        Map.entry(no.nav.foreldrepenger.domene.modell.Inntektskategori.SJØMANN, Inntektskategori.SJØMANN),
        Map.entry(no.nav.foreldrepenger.domene.modell.Inntektskategori.DAGMAMMA, Inntektskategori.DAGMAMMA),
        Map.entry(no.nav.foreldrepenger.domene.modell.Inntektskategori.JORDBRUKER, Inntektskategori.JORDBRUKER),
        Map.entry(no.nav.foreldrepenger.domene.modell.Inntektskategori.FISKER, Inntektskategori.FISKER),
        Map.entry(no.nav.foreldrepenger.domene.modell.Inntektskategori.ARBEIDSTAKER_UTEN_FERIEPENGER, Inntektskategori.ARBEIDSTAKER_UTEN_FERIEPENGER)
    );
