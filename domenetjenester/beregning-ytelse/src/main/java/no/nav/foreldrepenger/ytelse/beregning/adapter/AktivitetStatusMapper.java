...
final class AktivitetStatusMapper {
    ...
    static no.nav.foreldrepenger.ytelse.beregning.regelmodell.beregningsgrunnlag.AktivitetStatus fraVLTilRegel(no.nav.foreldrepenger.domene.entiteter.AktivitetStatus vlAktivitetStatus) {
