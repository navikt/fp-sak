...
class TilbaketrekkVedTilkommetArbeidsforholdTjenesteTest {
    ...
    void skal_finne_største_tilbaketrekk_ved_tilbaketrekk_mellom_to_arbeidsforhold() {
        ...
        // Act
        var tilbaketrekkForTilkommetArbeidEntry = finnStørsteTilbaketrekkForTilkomneArbeidsforhold(revurderingNøkler, originaleNøkler,
    ...
    void skal_finne_største_tilbaketrekk_ved_tilbaketrekk_mellom_tre_avsluttede_og_en_tilkommet_tilbaketrekk_mindre_enn_refusjon() {
        ...
        var eksisterendeAktivitet3 = lagYrkesaktivitet(
            DatoIntervallEntitet.fraOgMedTilOgMed(SKJÆRINGSTIDSPUNKT.minusMonths(10), SKJÆRINGSTIDSPUNKT.plusMonths(2).plusDays(1)), ARBEIDSGIVER4,
            InternArbeidsforholdRef.nullRef());
        var tilkommetAktivitet = lagYrkesaktivitet(DatoIntervallEntitet.fraOgMed(SKJÆRINGSTIDSPUNKT.plusMonths(1).plusDays(1)), ARBEIDSGIVER2,
            InternArbeidsforholdRef.nullRef());
    ...
    void skal_finne_største_tilbaketrekk_ved_tilbaketrekk_mellom_tre_avsluttede_og_tre_tilkommet_men_kun_deler_av_settet_er_med_i_tilbaketrekk() {
        ...
        var revurderingNøkler = List.of(tilkommetNøkkel, tilkommetNøkkel2, tilkommetNøkkel3, revurderingNøkkel, revurderingNøkkel2,
            revurderingNøkkel3);
        var originaleNøkler = List.of(originalNøkkel, originalNøkkel2, originalNøkkel3);
    ...
    private BRNøkkelMedAndeler lagNøkkelForAndelerMedFullUtbetalingTilBruker(int dagsats,
    ...
    private BRNøkkelMedAndeler lagNøkkelForAndelerMedFullUtbetalingTilArbeidsgiver(int dagsats,
                                                                                   Arbeidsgiver arbeidsgiver,
                                                                                   BeregningsresultatPeriode periode) {
        var brukersAndel = BeregningsresultatAndel.builder()
            .medDagsats(0)
