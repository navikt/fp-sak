...
class InngangsvilkårOpptjeningTest {
    ...
    void test_beregn_opptjening_fra_vilkår_input_data_som_gir_opptjening_P5M7D() {
        ...
        var expectedTimeline = new LocalDateTimeline<>(new LocalDateInterval(LocalDate.parse("2017-08-29"), LocalDate.parse("2018-01-30")), Boolean.TRUE);
    ...
    void test_beregn_opptjening_fra_vilkår_input_data_som_gir_opptjening_P5M3D() {
        ...
        var expectedTimeline = new LocalDateTimeline<>(new LocalDateInterval(LocalDate.parse("2017-08-29"), LocalDate.parse("2018-01-31")), Boolean.TRUE);
        assertThat(output.getResultatTidslinje()).isEqualTo(expectedTimeline);
    }
    ...
    void test_beregn_opptjening_fra_vilkår_input_data_som_gir_opptjening_P9M18D() {
        ...
        var expectedTimeline = new LocalDateTimeline<>(new LocalDateInterval(LocalDate.parse("2016-10-14"), LocalDate.parse("2017-07-31")), Boolean.TRUE);
        assertThat(output.getResultatTidslinje()).isEqualTo(expectedTimeline);
    }
    ...
    void test_beregn_opptjening_fra_vilkår_input_data_som_gir_opptjening_P7M18D_med_utlandsk_arbeidshold() {
        ...
        var expectedTimeline = new LocalDateTimeline<>(new LocalDateInterval(LocalDate.parse("2016-10-14"), LocalDate.parse("2017-05-31")), Boolean.TRUE);
        assertThat(output.getResultatTidslinje()).isEqualTo(expectedTimeline);
    }
