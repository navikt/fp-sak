...
public class SjekkBrukerErAvklartMedLovligOpphold extends LeafSpecification<MedlemskapsvilkårGrunnlag> {
    ...
    static final MerknadRuleReasonRef IKKE_OPPFYLT_BRUKER_HAR_IKKE_LOVLIG_OPPHOLD = new MerknadRuleReasonRef(RegelUtfallMerknad.RVM_1023,
        "Bruker har ikke lovlig opphold.");
