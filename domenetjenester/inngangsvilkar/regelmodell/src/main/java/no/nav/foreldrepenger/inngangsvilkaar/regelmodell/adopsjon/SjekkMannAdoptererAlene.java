...
class SjekkMannAdoptererAlene extends LeafSpecification<AdopsjonsvilkårGrunnlag> {
    ...
    static final MerknadRuleReasonRef IKKE_OPPFYLT_MANN_ADOPTERER_IKKE_ALENE = new MerknadRuleReasonRef(RegelUtfallMerknad.RVM_1006,
        "Mann adopterer ikke alene.");
