...
public record MedlemskapsvilkårGrunnlag(RegelPersonStatusType personStatusType, boolean brukerNorskNordisk, boolean brukerBorgerAvEUEOS,
                                        boolean brukerHarOppholdstillatelse, boolean harSøkerArbeidsforholdOgInntekt, boolean brukerErMedlem,
                                        boolean brukerAvklartPliktigEllerFrivillig, boolean brukerAvklartBosatt,
                                        boolean brukerAvklartLovligOppholdINorge, boolean brukerAvklartOppholdsrett) implements VilkårGrunnlag {
