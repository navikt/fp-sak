...
class SjekkEktefellesEllerSamboersBarn extends LeafSpecification<AdopsjonsvilkårGrunnlag> {
    ...
    static final MerknadRuleReasonRef IKKE_OPPFYLT_ADOPSJON_AV_EKTEFELLE_ELLER_SAMBOERS_BARN = new MerknadRuleReasonRef(RegelUtfallMerknad.RVM_1005,
        "Adopsjon av ektefelles eller samboers barn.");
