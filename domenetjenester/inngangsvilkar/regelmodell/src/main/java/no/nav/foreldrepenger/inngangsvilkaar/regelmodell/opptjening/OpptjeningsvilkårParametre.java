 ...
 */
public record OpptjeningsvilkårParametre(int minsteAntallMånederGodkjent, int minsteAntallDagerGodkjent, Long minsteInntekt,
                                         Period maksMellomliggendePeriodeForArbeidsforhold,
                                         Period minForegåendeForMellomliggendePeriodeForArbeidsforhold, boolean skalGodkjenneBasertPåAntatt,
    ...
    public static OpptjeningsvilkårParametre opptjeningsparametreForeldrepenger() {
        return new OpptjeningsvilkårParametre(5, 26, 1L, Period.ofDays(14), Period.ofWeeks(4), false, Period.ofMonths(2));
    }

    public static OpptjeningsvilkårParametre opptjeningsparametreSvangerskapspenger() {
        return new OpptjeningsvilkårParametre(0, 28, 1L, Period.ofDays(14), Period.ofWeeks(4), true, Period.ofMonths(2));
    }
