...
class PeriodeSplitterMotHøyreTest {
    ...
    void justert_periode_er_før_ikke_flyttbar_periode() {
        ...
        var splittedePerioder = PeriodeSplitter.splittPeriodeMotHøyre(List.of(utsettelsePgaFerie), uttakPeriode, 7);
    ...
    void justert_periode_kommer_etter_ikke_flyttbar_periode() {
        ...
        var splittedePerioder = PeriodeSplitter.splittPeriodeMotHøyre(List.of(utsettelsePgaFerie), uttakPeriode, 14);
    ...
    void justert_periode_overlapper_på_begynnelsen_av_ikke_flyttbar_periode() {
        ...
        var splittedePerioder = PeriodeSplitter.splittPeriodeMotHøyre(List.of(utsettelsePgaFerie), uttakPeriode, 9);
    ...
    void justert_periode_flyttes_mellom_to_ikke_flyttbar_perioder() {
        ...
        var splittedePerioder = PeriodeSplitter.splittPeriodeMotHøyre(List.of(utsettelsePgaFerie1, utsettelsePgaFerie2), uttakPeriode, 7);
    ...
    void justert_periode_flyttes_etter_to_ikke_flyttbar_perioder() {
        ...
        var splittedePerioder = PeriodeSplitter.splittPeriodeMotHøyre(List.of(utsettelsePgaFerie1, utsettelsePgaFerie2), uttakPeriode, 14);
