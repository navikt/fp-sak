...
public class BrukerHarAleneomsorgAksjonspunktUtlederTest {
    ...
    public void aksjonspunkter_dersom_søker_oppgitt_ha_aleneomsorg_men_oppgitt_annenForeldre_og_ha_samme_address_som_bruker() {
        ...
        when(personopplysninger.harOppgittAnnenpart(ref)).thenReturn(true);
    ...
    public void aksjonspunkter_dersom_bruker_ikke_oppgitt_annenForeldre_men_er_gift_og_ha_samme_address_som_bruker() {
        ...
        when(personopplysninger.harOppgittAnnenpart(BehandlingReferanse.fra(behandling))).thenReturn(false);
    ...
    private OppgittRettighetEntitet oppgittRettighet(Boolean harAnnenForeldreRett, Boolean harAleneomsorgForBarnet) {
        return new OppgittRettighetEntitet(harAnnenForeldreRett, true, harAleneomsorgForBarnet);
    }
