...
public class OppgittPeriodeUtilTest {
    ...
    public void sorterEtterFom() {
        ...
        List<OppgittPeriodeEntitet> perioder = OppgittPeriodeUtil.sorterEtterFom(List.of(periode1, periode2));
    ...
    public void første_søkte_dato_kan_være_overføringsperiode() {
        ...
        OppgittPeriodeEntitet førstePeriodeOverføring = OppgittPeriodeBuilder.ny()
            .medPeriodeType(UttakPeriodeType.MØDREKVOTE)
            .medÅrsak(OverføringÅrsak.SYKDOM_ANNEN_FORELDER)
            .medPeriode(LocalDate.of(2018, 6, 11), LocalDate.of(2018, 6, 17))
            .build();

        OppgittPeriodeEntitet andrePeriodeUttaksperiode = OppgittPeriodeBuilder.ny()
            .medPeriodeType(UttakPeriodeType.FELLESPERIODE)
            .medPeriode(LocalDate.of(2018, 6, 18), LocalDate.of(2018, 6, 28))
            .build();

        Optional<LocalDate> førsteSøkteUttaksdato = OppgittPeriodeUtil.finnFørsteSøkteUttaksdato(List.of(førstePeriodeOverføring, andrePeriodeUttaksperiode));
    ...
    public void første_søkte_dato_kan_være_vanlig_uttaksperiode() {
        ...
        OppgittPeriodeEntitet førstePeriodeUttaksperiode = OppgittPeriodeBuilder.ny()
            .medPeriodeType(UttakPeriodeType.MØDREKVOTE)
            .medPeriode(LocalDate.of(2018, 6, 11), LocalDate.of(2018, 6, 17))
            .build();

        OppgittPeriodeEntitet andrePeriodeOverføring = OppgittPeriodeBuilder.ny()
            .medPeriodeType(UttakPeriodeType.FELLESPERIODE)
            .medÅrsak(OverføringÅrsak.SYKDOM_ANNEN_FORELDER)
            .medPeriode(LocalDate.of(2018, 6, 18), LocalDate.of(2018, 6, 28))
            .build();

        Optional<LocalDate> førsteSøkteUttaksdato = OppgittPeriodeUtil.finnFørsteSøkteUttaksdato(List.of(førstePeriodeUttaksperiode, andrePeriodeOverføring));
    ...
    public void første_søkte_dato_kan_være_utsettelseperioder() {
        ...
        OppgittPeriodeEntitet førstePeriodeUtsettelse = OppgittPeriodeBuilder.ny()
            .medPeriodeType(UttakPeriodeType.MØDREKVOTE)
        ...
        Optional<LocalDate> førsteSøkteUttaksdato = OppgittPeriodeUtil.finnFørsteSøkteUttaksdato(List.of(førstePeriodeUtsettelse, andrePeriodeUttaksperiode));
    ...
    public void første_søkte_dato_skal_ikke_være_oppholdsperioder() {
        ...
        OppgittPeriodeEntitet førstePeriodeOpphold = OppgittPeriodeBuilder.ny()
            .medPeriodeType(UttakPeriodeType.MØDREKVOTE)
        ...
        Optional<LocalDate> førsteSøkteUttaksdato = OppgittPeriodeUtil.finnFørsteSøkteUttaksdato(List.of(førstePeriodeOpphold, andrePeriodeUttaksperiode));
