...
public class KontrollerFaktaUttakTjenesteTest {
    ...
    public void aksjonspunkt_dersom_far_søker_og_ikke_oppgitt_omsorg_til_barnet() {
        ...
        //Act
        var familieHendelse = FamilieHendelse.forFødsel(null, idag, List.of(new Barn()), 1);
        ...
        var input = new UttakInput(BehandlingReferanse.fra(behandling, idag), null, fpGrunnlag);
