...
public final class UttakEnumMapper {
    ...
    public static DokumentasjonVurdering map(no.nav.foreldrepenger.behandlingslager.behandling.ytelsefordeling.periode.DokumentasjonVurdering dokumentasjonVurdering) {
        ...
        return switch (dokumentasjonVurdering) {
            case SYKDOM_SØKER_GODKJENT -> DokumentasjonVurdering.SYKDOM_SØKER_DOKUMENTERT;
            case SYKDOM_ANNEN_FORELDER_GODKJENT -> DokumentasjonVurdering.SYKDOM_ANNEN_FORELDER_DOKUMENTERT;
            case INNLEGGELSE_SØKER_GODKJENT -> DokumentasjonVurdering.INNLEGGELSE_SØKER_DOKUMENTERT;
            case INNLEGGELSE_ANNEN_FORELDER_GODKJENT -> DokumentasjonVurdering.INNLEGGELSE_ANNEN_FORELDER_DOKUMENTERT;
            case INNLEGGELSE_BARN_GODKJENT -> DokumentasjonVurdering.INNLEGGELSE_BARN_DOKUMENTERT;
            case HV_OVELSE_GODKJENT -> DokumentasjonVurdering.HV_OVELSE_DOKUMENTERT;
            case NAV_TILTAK_GODKJENT -> DokumentasjonVurdering.NAV_TILTAK_DOKUMENTERT;
            case MORS_AKTIVITET_GODKJENT -> DokumentasjonVurdering.MORS_AKTIVITET_DOKUMENTERT_AKTIVITET;
            case MORS_AKTIVITET_IKKE_GODKJENT -> DokumentasjonVurdering.MORS_AKTIVITET_DOKUMENTERT_IKKE_AKTIVITET;
            case MORS_AKTIVITET_IKKE_DOKUMENTERT -> DokumentasjonVurdering.MORS_AKTIVITET_IKKE_DOKUMENTERT;
            case ALENEOMSORG_GODKJENT -> DokumentasjonVurdering.ER_ALENEOMSORG;
            case BARE_SØKER_RETT_GODKJENT -> DokumentasjonVurdering.ER_BARE_SØKER_RETT;
            case TIDLIG_OPPSTART_FEDREKVOTE_GODKJENT -> DokumentasjonVurdering.TIDLIG_OPPSTART_FEDREKVOTE_DOKUMENTERT;
            //Reglene trenger ikke å skille mellom "ikke dokumentert" og "ikke vurdert", setter derfor null
            case SYKDOM_SØKER_IKKE_GODKJENT, SYKDOM_ANNEN_FORELDER_IKKE_GODKJENT, INNLEGGELSE_SØKER_IKKE_GODKJENT, INNLEGGELSE_ANNEN_FORELDER_IKKE_GODKJENT, INNLEGGELSE_BARN_IKKE_GODKJENT, HV_OVELSE_IKKE_GODKJENT, NAV_TILTAK_IKKE_GODKJENT, TIDLIG_OPPSTART_FEDREKVOTE_IKKE_GODKJENT, ALENEOMSORG_IKKE_GODKJENT, BARE_SØKER_RETT_IKKE_GODKJENT -> null;
        };
    }
}
