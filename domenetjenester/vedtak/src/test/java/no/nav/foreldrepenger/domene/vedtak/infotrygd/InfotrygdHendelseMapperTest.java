...
import no.nav.foreldrepenger.domene.vedtak.infotrygd.InfotrygdEndret;
import no.nav.foreldrepenger.domene.vedtak.infotrygd.InfotrygdHendelse;
import no.nav.foreldrepenger.domene.vedtak.infotrygd.InfotrygdHendelseMapper;
import no.nav.foreldrepenger.domene.vedtak.infotrygd.InfotrygdInnvilget;
import no.nav.foreldrepenger.domene.vedtak.infotrygd.InfotrygdOpphørt;
