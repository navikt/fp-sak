...
interface TransformerVedtakXmlFeil extends DeklarerteFeil {
    ...
    @TekniskFeil(feilkode = "FP-376156", feilmelding = "Feil ved parsing av vedtaksxml namespace '%s'", logLevel = LogLevel.WARN)
    Feil uventetFeilVedParsingAvVedtaksXml(Long behandlingId, String nameSpaceOfXML, Exception cause);
